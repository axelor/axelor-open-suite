...
public class ProjectPlanningController {
  ...
  @Inject protected ProjectPlanningService projectPlanningService;

  @Inject protected ProjectPlanningLineRepository projectPlanningLineRepository;

  @Inject protected ProjectPlanningRepository projectPlanningRepo;
  ...
  public void myPlanning(ActionRequest request, ActionResponse response) throws AxelorException {
    ...
    ProjectPlanning planning =
        projectPlanningRepo
            .all()
            .filter(
                "self.year = ?1 AND self.week = ?2",
                todayDate.getYear(),
                todayDate.getWeekOfWeekyear())
            .fetchOne();
    if (planning == null) {
      planning =
          projectPlanningService.createPlanning(todayDate.getYear(), todayDate.getWeekOfWeekyear());
    }
    response.setView(
        ActionView.define("Week" + planning.getWeek())
  ...
  public void myTeamPlanning(ActionRequest request, ActionResponse response)
  ...
  public void planningPreviousWeek(ActionRequest request, ActionResponse response)
      throws AxelorException {
    ...
    planningPreviousWeek =
        projectPlanningRepo
            .all()
            .filter("self.year = ?1 AND self.week = ?2", year, previousWeek)
            .fetchOne();
    ...
    if (type.contentEquals("user")) {
      response.setView(
          ActionView.define("Week" + planningPreviousWeek.getWeek())
              .model(ProjectPlanning.class.getName())
              .add("form", "project-my-planning-form")
              .param("forceEdit", "true")
  ...
  public void planningNextWeek(ActionRequest request, ActionResponse response)
      throws AxelorException {
    ProjectPlanning planning = request.getContext().asType(ProjectPlanning.class);
    ...
    planningNextWeek =
        projectPlanningRepo
            .all()
            .filter("self.year = ?1 AND self.week = ?2", year, nextWeek)
            .fetchOne();
    ...
    if (type.contentEquals("user")) {
      response.setView(
          ActionView.define("Week" + planningNextWeek.getWeek())
              .model(ProjectPlanning.class.getName())
              .add("form", "project-my-planning-form")
              .param("forceEdit", "true")
  ...
  public void planningCurrentWeek(ActionRequest request, ActionResponse response)
      throws AxelorException {
    ...
    planningCurrentWeek =
        projectPlanningRepo
            .all()
            .filter("self.year = ?1 AND self.week = ?2", year, week)
            .fetchOne();
    ...
    if (type.contentEquals("user")) {
      response.setView(
          ActionView.define("Week" + planningCurrentWeek.getWeek())
              .model(ProjectPlanning.class.getName())
              .add("form", "project-my-planning-form")
              .param("forceEdit", "true")
      ...
      if (type.contentEquals("user")) {
        ...
        if (user.getActiveTeam() == null) {
          throw new AxelorException(
              IExceptionMessage.PROJECT_NO_ACTIVE_TEAM, IException.CONFIGURATION_ERROR);
        } else {
          projectPlanningLineList =
              projectPlanningService.populateMyTeamPlanning(planning, user.getActiveTeam());
        }
      }
    } catch (Exception e) {
  ...
  public void saveLines(ActionRequest request, ActionResponse response) throws AxelorException {
    List<ProjectPlanningLine> planningLineList =
        (List<ProjectPlanningLine>) request.getContext().get("projectPlanningLineList");

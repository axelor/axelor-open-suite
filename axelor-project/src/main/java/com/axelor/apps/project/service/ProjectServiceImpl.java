...
public class ProjectServiceImpl implements ProjectService {
  ...
  public ProjectTask createTask(
    ...
    if (taskTemplateSet != null
        ...
        && taskTemplateSet.contains(parentTaskTemplate)) {
  ...
  public boolean checkIfResourceBookedInList(
    ...
    return ListUtils.emptyIfNull(resourceBookingList).stream()
        .anyMatch(
            x ->
  ...
  public void getChildProjectIds(Set<Long> projectIdsSet, Project project) {
    if (projectIdsSet != null && projectIdsSet.contains(project.getId())) {
      return;
    }

    if (projectIdsSet == null) {
      projectIdsSet = new HashSet<>();
    }

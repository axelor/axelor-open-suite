...
public final class NammingTool {
	...
	// Java Keywords
	private static final Set<String> RESERVED_JAVA = new LinkedHashSet<>(Arrays.asList(
		"abstract",
		"assert",
		"boolean",
		"break",
	...
	// PostgreSQL 9.x
	private static final Set<String> RESERVED_POSTGRESQL = new LinkedHashSet<>(Arrays.asList(
		"all",
		"analyse",
		"analyze",
		"and",
	...
	private static final Set<String> RESERVED_MYSQL = new LinkedHashSet<>(Arrays.asList(
		"accessible",
		"add",
		"all",
		"alter",
	...
	// Oracle
	private static final Set<String> RESERVED_ORACLE = new LinkedHashSet<String>(Arrays.asList(
		"access",
		"add",
		"all",
		"alter",

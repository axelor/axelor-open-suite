...
import com.axelor.apps.helpdesk.service.HelpDeskChartService;
import com.axelor.apps.helpdesk.service.HelpDeskChartServiceImpl;
...
public class HelpdeskModule extends AxelorModule {
  ...
  protected void configure() {
    ...
    bind(HelpDeskChartService.class).to(HelpDeskChartServiceImpl.class);
  }
}

...
public class InventoryService {
  ...
  public Inventory createInventory(
    ...
    if (location == null) {
      throw new AxelorException(
          I18n.get(IExceptionMessage.INVENTORY_1), IException.CONFIGURATION_ERROR);
    }
  ...
  public void importFile(String filePath, char separator, Inventory inventory)
    ...
    for (String[] line : data) {
      if (line.length < 6)
        throw new AxelorException(
            I18n.get(IExceptionMessage.INVENTORY_3), IException.CONFIGURATION_ERROR);
      ...
      if (inventoryLineMap.containsKey(code)) {
        ...
        if (product == null
          ...
          throw new AxelorException(
              I18n.get(IExceptionMessage.INVENTORY_4) + " " + code, IException.CONFIGURATION_ERROR);
  ...
  public List<String[]> getDatas(String filePath, char separator) throws AxelorException {
    ...
    try {
      ...
      throw new AxelorException(
          I18n.get(IExceptionMessage.INVENTORY_5), IException.CONFIGURATION_ERROR);
    }
  ...
  public StockMove generateStockMove(Inventory inventory) throws AxelorException {
    ...
    if (company == null) {
      throw new AxelorException(
          String.format(I18n.get(IExceptionMessage.INVENTORY_6), toLocation.getName()),
          IException.CONFIGURATION_ERROR);
    }
    ...
    StockMove stockMove =
        this.createStockMoveHeader(
            inventory, company, toLocation, inventory.getDateT().toLocalDate(), inventorySeq);
    ...
    StockMove stockMove =
        Beans.get(StockMoveService.class)
            .createStockMove(
                ...
                company,
                null,
                stockConfigService.getInventoryVirtualLocation(

...
public interface IExceptionMessage {
  ...
  static final String STOCK_MOVE_5 = /*$$(*/
      "There's no source location selected for the stock's movement %s" /*)*/;
  static final String STOCK_MOVE_6 = /*$$(*/
      "There's no destination location selected for the stock's movement %s" /*)*/;
  ...
  static final String STOCK_CONFIG_2 = /*$$(*/
      "You must configure an inventory virtual location for the company %s" /*)*/;
  static final String STOCK_CONFIG_3 = /*$$(*/
      "You must configure a supplier virtual location for the company %s" /*)*/;
  static final String STOCK_CONFIG_4 = /*$$(*/
      "You must configure a customer virtual location for the company %s" /*)*/;

...
public class EbicsUtils {
  ...
  public static byte[] zip(byte[] toZip) throws AxelorException {
    ...
    if (toZip == null) {
      throw new AxelorException(I18n.get("The input to be zipped cannot be null"), IException.MISSING_FIELD);
    }
  ...
  public static byte[] generateNonce() throws AxelorException {
    ...
    try {
      ...
      throw new AxelorException(e.getMessage(), IException.FUNCTIONNAL);
    }
  }

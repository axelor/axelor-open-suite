 ...
 */
package com.axelor.apps.bank.payment.ebics.client;

import java.io.IOException;
import java.io.OutputStream;
import java.util.Date;

import com.axelor.apps.bank.payment.db.EbicsTransferState;
...
import com.axelor.apps.bank.payment.ebics.xml.DTransferResponseElement;
import com.axelor.apps.bank.payment.ebics.xml.DefaultEbicsRootElement;
import com.axelor.apps.bank.payment.ebics.xml.InitializationResponseElement;
import com.axelor.apps.bank.payment.ebics.xml.ReceiptRequestElement;
import com.axelor.apps.bank.payment.ebics.xml.ReceiptResponseElement;
import com.axelor.apps.bank.payment.ebics.xml.TransferResponseElement;
import com.axelor.apps.bank.payment.ebics.xml.UInitializationRequestElement;
import com.axelor.apps.bank.payment.ebics.xml.UTransferRequestElement;
...
public class FileTransfer {
    ...
    throws IOException, AxelorException
  {
    ...
    while( segNumber <= state.getNumSegments() ) {
      ...
      sendFile(initializer.getContent(segNumber),
    		  					  segNumber,

...
public class BankOrderFileAFB160DCOService extends BankOrderFileService {
  ...
  protected String createSenderRecord() throws AxelorException {
    ...
    try {
      ...
      throw new AxelorException(
          ...
          I18n.get(BankPaymentExceptionMessage.BANK_ORDER_WRONG_SENDER_RECORD) + ": " + e.getMessage(),
          bankOrderSeq);
    }
  }
  ...
  protected String createMainDetailRecord(BankOrderLine bankOrderLine) throws AxelorException {
    ...
    try {
      ...
      throw new AxelorException(
          e,
          TraceBackRepository.CATEGORY_MISSING_FIELD,
          I18n.get(BankPaymentExceptionMessage.BANK_ORDER_WRONG_MAIN_DETAIL_RECORD) + ": " + e.getMessage(),
          bankOrderLine.getSequence());
    }
  }
  ...
  protected String createTotalRecord() throws AxelorException {
    ...
    try {
      ...
      throw new AxelorException(
          e,
          TraceBackRepository.CATEGORY_MISSING_FIELD,
          I18n.get(BankPaymentExceptionMessage.BANK_ORDER_WRONG_TOTAL_RECORD) + ": " + e.getMessage(),
          bankOrderSeq);
    }
  }
  ...
  protected String getAdditionalC3Value(Address address, Partner partner) throws AxelorException {
    if (address == null) {
      throw new AxelorException(
          TraceBackRepository.CATEGORY_MISSING_FIELD,
          I18n.get(BankPaymentExceptionMessage.BANK_ORDER_RECEIVER_BANK_DETAILS_MISSING_PARTNER_ZIP),
          partner.getFullName());
    }
  ...
  protected String getAdditionalC2Value(Address address, Partner partner) throws AxelorException {
    if (address == null || address.getCity() == null) {
      throw new AxelorException(
          TraceBackRepository.CATEGORY_MISSING_FIELD,
          I18n.get(BankPaymentExceptionMessage.BANK_ORDER_RECEIVER_BANK_DETAILS_MISSING_PARTNER_CITY),
          partner.getFullName());
    }
  ...
  protected String getAdditionalC1Value(Address address, Partner partner) throws AxelorException {
    if (address == null) {
      throw new AxelorException(
          TraceBackRepository.CATEGORY_MISSING_FIELD,
          I18n.get(BankPaymentExceptionMessage.BANK_ORDER_RECEIVER_BANK_DETAILS_MISSING_PARTNER_ADDRESS),
          partner.getFullName());
    }

...
public class MoveLineMassEntryDomainBankPaymentServiceImpl extends MoveLineMassEntryDomainServiceImpl {
    protected BankDetailsBankPaymentService bankDetailsBankPaymentService;

    @Inject
    public MoveLineMassEntryDomainBankPaymentServiceImpl(BankDetailsBankPaymentService bankDetailsBankPaymentService) {

    ...
    switch (partnerTypeSelect) {
      ...
      case BankOrderRepository.PARTNER_TYPE_COMPANY:
        if (receiverCompany.equals(senderCompany)) {
          return accountConfigBankPaymentService.getInternalBankToBankAccount(
              accountConfigBankPaymentService.getAccountConfig(moveCompany));
        } else {
          return accountConfigBankPaymentService.getExternalBankToBankAccount(
              accountConfigBankPaymentService.getAccountConfig(moveCompany));
        }

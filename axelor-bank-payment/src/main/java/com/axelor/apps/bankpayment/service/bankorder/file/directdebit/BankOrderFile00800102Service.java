...
public class BankOrderFile00800102Service extends BankOrderFileService {
   ...
   * @throws DatatypeConfigurationException
   */
  private void createGrpHdr(GroupHeader39 groupHeader, PartyIdentification32 creditor)
      throws DatatypeConfigurationException {
  ...
  private void createDrctDbtTxInf(
    ...
    for (BankOrderLine bankOrderLine : bankOrderLineList) {
       ...
       */
      mandateRelatedInformation6.setMndtId(
      ...
      FinancialInstitutionIdentification7 financialInstitutionIdentification7 =
          factory.createFinancialInstitutionIdentification7();
      financialInstitutionIdentification7.setBIC(

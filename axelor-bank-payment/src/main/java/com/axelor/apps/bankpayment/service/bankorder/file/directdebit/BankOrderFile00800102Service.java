...
public class BankOrderFile00800102Service extends BankOrderFileService {
     ...
     *
     * @param paymentInstructionInformationList the list to add the {@link PaymentInstructionInformation4} objects into
     * @param creditor the creditor of the SEPA Direct Debit file
     * @throws DatatypeConfigurationException
     */
    private void createPmtInf(List<PaymentInstructionInformation4> paymentInstructionInformationList, PartyIdentification32 creditor) throws AxelorException, DatatypeConfigurationException {
         ...
         *          RCUR, FNAL).
         */
        paymentInstructionInformation4.setReqdColltnDt(datatypeFactory.newXMLGregorianCalendar(bankOrderDate.toString("yyyy-MM-dd")));
     ...
     * and adds it into the provided {@link DirectDebitTransactionInformation9} list
     *
    ...
    private void createDrctDbtTxInf(List<DirectDebitTransactionInformation9> directDebitTransactionInformation9List, PartyIdentification32 creditor) throws DatatypeConfigurationException {
        ...
        for (BankOrderLine bankOrderLine : bankOrderLineList) {
            ...
            mandateRelatedInformation6.setMndtId(bankOrderLine.getPartner().getActiveUmr().getUmrNumber());
                     ...
                     * Format : YYYY-MM-DD
                     */
            mandateRelatedInformation6.setDtOfSgntr(datatypeFactory.newXMLGregorianCalendar(bankOrderLine.getPartner().getActiveUmr().getMandateSignatureDate().toString("yyyy-MM-dd")));
                    /*
            ...
            // mandateRelatedInformation6.setAmdmntInd(???);
                     ...
                     */
            // AmendmentInformationDetails6 amendmentInformationDetails6 = factory.createAmendmentInformationDetails6();
            ...
            directDebitTransactionInformation9.setRmtInf(remittanceInformation5);
                 ...
                 */
                // StructuredRemittanceInformation7 structuredRemittanceInformation7 = factory.createStructuredRemittanceInformation7();

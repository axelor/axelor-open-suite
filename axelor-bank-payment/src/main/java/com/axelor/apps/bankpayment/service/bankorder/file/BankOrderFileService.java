...
public class BankOrderFileService {
  ...
  protected String getFolderPath() throws AxelorException {
    ...
    if (Strings.isNullOrEmpty(folderPath)) {
      ...
      throw new AxelorException(
          String.format(
              I18n.get(IExceptionMessage.BANK_ORDER_FILE_NO_FOLDER_PATH), paymentMode.getName()),
          IException.INCONSISTENCY);
    }
  ...
  public File generateFile()
    ...
    switch (fileExtension) {
      ...
      default:
        throw new AxelorException(
            String.format(
                I18n.get(IExceptionMessage.BANK_ORDER_FILE_UNKNOWN_FORMAT), paymentMode.getName()),
            IException.INCONSISTENCY);
    }
  }

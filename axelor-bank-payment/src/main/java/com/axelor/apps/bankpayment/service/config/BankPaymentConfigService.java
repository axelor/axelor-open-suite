...
public class BankPaymentConfigService  {
	...
	public Account getExternalBankToBankAccount(BankPaymentConfig bankPaymentConfig) throws AxelorException  {
		if (bankPaymentConfig.getExternalBankToBankAccount() == null) {
			throw new AxelorException(bankPaymentConfig, TraceBackRepository.CATEGORY_CONFIGURATION_ERROR, I18n.get(IExceptionMessage.ACCOUNT_CONFIG_EXTERNAL_BANK_TO_BANK_ACCOUNT), AppBaseServiceImpl.EXCEPTION,bankPaymentConfig.getCompany().getName());
		}
	...
	public Account getInternalBankToBankAccount(BankPaymentConfig bankPaymentConfig) throws AxelorException  {
		if (bankPaymentConfig.getInternalBankToBankAccount() == null) {
			throw new AxelorException(bankPaymentConfig, TraceBackRepository.CATEGORY_CONFIGURATION_ERROR, I18n.get(IExceptionMessage.ACCOUNT_CONFIG_INTERNAL_BANK_TO_BANK_ACCOUNT), AppBaseServiceImpl.EXCEPTION,bankPaymentConfig.getCompany().getName());
		}
	...
	public Sequence getSepaCreditTransSequence(BankPaymentConfig bankPaymentConfig) throws AxelorException {
		if (bankPaymentConfig.getSepaCreditTransSequence() == null) {
			throw new AxelorException(bankPaymentConfig, TraceBackRepository.CATEGORY_CONFIGURATION_ERROR, I18n.get(IExceptionMessage.ACCOUNT_CONFIG_SEQUENCE_5), AppBaseServiceImpl.EXCEPTION, bankPaymentConfig.getCompany().getName());
		}
	...
	public Sequence getSepaDirectDebitSequence(BankPaymentConfig bankPaymentConfig) throws AxelorException {
		if (bankPaymentConfig.getSepaDirectDebitSequence() == null) {
			throw new AxelorException(bankPaymentConfig, TraceBackRepository.CATEGORY_CONFIGURATION_ERROR, I18n.get(IExceptionMessage.ACCOUNT_CONFIG_SEQUENCE_6), AppBaseServiceImpl.EXCEPTION, bankPaymentConfig.getCompany().getName());
		}
	...
	public Sequence getIntCreditTransSequence(BankPaymentConfig bankPaymentConfig) throws AxelorException {
		if (bankPaymentConfig.getIntCreditTransSequence() == null) {
			throw new AxelorException(bankPaymentConfig, TraceBackRepository.CATEGORY_CONFIGURATION_ERROR, I18n.get(IExceptionMessage.ACCOUNT_CONFIG_SEQUENCE_7), AppBaseServiceImpl.EXCEPTION, bankPaymentConfig.getCompany().getName());
		}
	...
	public Sequence getIntDirectDebitSequence(BankPaymentConfig bankPaymentConfig) throws AxelorException {
		if (bankPaymentConfig.getIntDirectDebitSequence() == null) {
			throw new AxelorException(bankPaymentConfig, TraceBackRepository.CATEGORY_CONFIGURATION_ERROR, I18n.get(IExceptionMessage.ACCOUNT_CONFIG_SEQUENCE_8), AppBaseServiceImpl.EXCEPTION, bankPaymentConfig.getCompany().getName());
		}
	...
	public Sequence getNatTreasuryTransSequence(BankPaymentConfig bankPaymentConfig) throws AxelorException {
		if (bankPaymentConfig.getNatTreasuryTransSequence() == null) {
			throw new AxelorException(bankPaymentConfig, TraceBackRepository.CATEGORY_CONFIGURATION_ERROR, I18n.get(IExceptionMessage.ACCOUNT_CONFIG_SEQUENCE_9), AppBaseServiceImpl.EXCEPTION, bankPaymentConfig.getCompany().getName());
		}
	...
	public Sequence getIntTreasuryTransSequence(BankPaymentConfig bankPaymentConfig) throws AxelorException {
		if (bankPaymentConfig.getIntTreasuryTransSequence() == null) {
			throw new AxelorException(bankPaymentConfig, TraceBackRepository.CATEGORY_CONFIGURATION_ERROR, I18n.get(IExceptionMessage.ACCOUNT_CONFIG_SEQUENCE_10), AppBaseServiceImpl.EXCEPTION, bankPaymentConfig.getCompany().getName());
		}
	...
	public Sequence getOtherBankOrderSequence(BankPaymentConfig bankPaymentConfig) throws AxelorException {
		if (bankPaymentConfig.getOtherBankOrderSequence() == null) {
			throw new AxelorException(bankPaymentConfig, TraceBackRepository.CATEGORY_CONFIGURATION_ERROR, I18n.get(IExceptionMessage.ACCOUNT_CONFIG_SEQUENCE_11), AppBaseServiceImpl.EXCEPTION, bankPaymentConfig.getCompany().getName());
		}
	...
	public User getDefaultSignatoryUser(BankPaymentConfig bankPaymentConfig) throws AxelorException {
		if (bankPaymentConfig.getDefaultSignatoryUser() == null) {
			throw new AxelorException(bankPaymentConfig, TraceBackRepository.CATEGORY_CONFIGURATION_ERROR, I18n.get(IExceptionMessage.ACCOUNT_CONFIG_41), AppBaseServiceImpl.EXCEPTION,bankPaymentConfig.getCompany().getName());
		}

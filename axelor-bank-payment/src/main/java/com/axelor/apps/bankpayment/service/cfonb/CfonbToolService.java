...
public class CfonbToolService {
	...
	/**
	 * "D" = Dépendant (Dependent), la condition de présence de la donnée est précisée dans les tableaux de description des enregistrements
	 */
	public final String STATUS_DEPENDENT = "D";
	/**
	 * "N" = Non utilisée (zone que le CFONB se réserve le droit d'utiliser ultérieurement qui doit alors être à
	 * blanc, ou zone non utilisée pour ce type de remise qui est alors ignorée par la banque).
	 */

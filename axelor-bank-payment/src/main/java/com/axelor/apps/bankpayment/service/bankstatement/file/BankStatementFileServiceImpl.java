...
public abstract class BankStatementFileServiceImpl implements BankStatementFileService {
  ...
  @Inject
  public BankStatementFileServiceImpl(BankStatementService bankStatementService) {

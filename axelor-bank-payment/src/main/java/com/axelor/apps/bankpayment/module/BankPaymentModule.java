...
import com.axelor.apps.account.service.invoice.InvoiceResetServiceImpl;
...
import com.axelor.apps.bankpayment.db.repo.MoveLineBankPaymentRepository;
...
import com.axelor.apps.bankpayment.service.ChequeRejectionBankPaymentService;
import com.axelor.apps.bankpayment.service.InvoiceResetServiceBankPaymentImpl;
...
import com.axelor.apps.bankpayment.service.PayerQualityBankPaymentService;
...
import com.axelor.apps.bankpayment.service.ReimbursementImportBankPaymentService;
...
import com.axelor.apps.bankpayment.service.cfonb.CfonbImportBankPaymentService;
...
import com.axelor.apps.bankpayment.service.move.MassEntryServiceBankPaymentImpl;
...
import com.axelor.apps.bankpayment.service.moveline.MoveLineDefaultServiceBankPaymentImpl;
...
import com.axelor.apps.bankpayment.service.moveline.MoveLineMassEntryGroupServiceBankPaymentImpl;
...
public class BankPaymentModule extends AxelorModule {
  ...
  protected void configure() {
    ...
    bind(MoveLineManagementRepository.class).to(MoveLineBankPaymentRepository.class);
    bind(MoveLineBankPaymentService.class).to(MoveLineBankPaymentServiceImpl.class);
    bind(ChequeRejectionService.class).to(ChequeRejectionBankPaymentService.class);
    bind(PayerQualityService.class).to(PayerQualityBankPaymentService.class);
    bind(CfonbImportService.class).to(CfonbImportBankPaymentService.class);
    bind(ReimbursementImportService.class).to(ReimbursementImportBankPaymentService.class);
    bind(InvoiceResetServiceImpl.class).to(InvoiceResetServiceBankPaymentImpl.class);
    bind(MoveLineServiceImpl.class).to(MoveLineBankPaymentServiceImpl.class);
    bind(MassEntryServiceImpl.class).to(MassEntryServiceBankPaymentImpl.class);
    bind(MoveLineMassEntryGroupServiceImpl.class)
        .to(MoveLineMassEntryGroupServiceBankPaymentImpl.class);
    bind(MoveLineDefaultServiceImpl.class).to(MoveLineDefaultServiceBankPaymentImpl.class);
  }
}

...
import com.axelor.apps.bankpayment.service.payment.paymentvoucher.PaymentVoucherCancelServiceBankPayImpl;
...
public class BankPaymentModule extends AxelorModule {
  ...
  protected void configure() {
    ...
    bind(PaymentVoucherCancelServiceImpl.class).to(PaymentVoucherCancelServiceBankPayImpl.class);
  }
}

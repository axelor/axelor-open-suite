...
public final class BankPaymentExceptionMessage {
  ...
  public static final String BANK_RECONCILIATION_BANK_DETILS_CURRENCY_NOT_COMPATIBLE = /*$$(*/
      "The bank reconciliation currency is different from the bank details currency so the reconciliation can't be initiated. Please select a currency which is equal to the bank statement currency." /*)*/;

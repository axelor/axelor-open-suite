...
public class OrderAttribute {
	 ...
	 * (D is also used for HIA, INI, HPB)
	 */
	...
	/**
	 * Compression type for order data and/or ES’s 
	 * Z = ZIP compression 
	 */
	...
	/**
	 * Encryption type for order data and/or ES’s
	 * N = no encryption
	...
	/**
	 * Depending on order type and possible further marginal conditions, an	EBICS client MUST 
	 * enter the following order attributes in the control data of the first EBICS request of 
	 * an EBICS transaction (ebicsRequest/header/static/OrderDetails/OrderAttribute): 
	 *
	 ...
	 * other upload order types 	| order data with transport signature 		|		DZHNN
	 * 								| (release of the order via accompanying	| 
	 * 								| note instead of bank-technical ES) 		|  
	 * other download order types	| download data request with financial 		|		OZHNN
	 * 								| institution’s banktechnical ES			|  
	 * other download order types 	| download data request without financial 	|		DZHNN
	 * 								| institution’s banktechnical ES 			|
	 * 
	 * @param orderType

...
public class BankOrderFile00800101Service extends BankOrderFileService {
    ...
    /**
     * Builds the GroupHeader part ({@code <GrpHdr>} tag) of the file, into the provided
     * {@link GroupHeader1} object
     *
     * @param groupHeader the {@link GroupHeader1} to build
     * @param creditor the creditor of the SEPA Direct Debit file
     * @throws DatatypeConfigurationException
     */
    private void createGrpHdr(GroupHeader1 groupHeader, PartyIdentification8 creditor) throws DatatypeConfigurationException {
         ...
         */
        groupHeader.setCreDtTm(datatypeFactory.newXMLGregorianCalendar(generationDateTime.toString("yyyy-MM-dd'T'HH:mm:ss")));
     ...
     *
     * @param paymentInstructionInformationList the list to add the {@link PaymentInstructionInformation2} objects into
     * @param creditor the creditor of the SEPA Direct Debit file
     * @throws DatatypeConfigurationException
     */
    private void createPmtInf(List<PaymentInstructionInformation2> paymentInstructionInformationList, PartyIdentification8 creditor) throws AxelorException, DatatypeConfigurationException {
        DatatypeFactory datatypeFactory = DatatypeFactory.newInstance();
         ...
         *          RCUR, FNAL).
         */
        paymentInstructionInformation2.setReqdColltnDt(datatypeFactory.newXMLGregorianCalendar(bankOrderDate.toString("yyyy-MM-dd")));
    ...
    /**
     * Builds the DirectDebitTransactionInformation part ({@code <DrctDbtTxInf>} tag) of the file,
     * and adds it into the provided {@link DirectDebitTransactionInformation1} list
     *
    ...
    private void createDrctDbtTxInf(List<DirectDebitTransactionInformation1> directDebitTransactionInformation1List, PartyIdentification8 creditor) throws DatatypeConfigurationException, AxelorException {
        ...
        for (BankOrderLine bankOrderLine : bankOrderLineList) {
            ...
            directDebitTransaction1.setMndtRltdInf(mandateRelatedInformation1);
                     ...
                     */
            mandateRelatedInformation1.setMndtId(bankOrderLine.getPartner().getActiveUmr().getUmrNumber());
                    /*
                     ...
                     * Format : YYYY-MM-DD
                     */
            mandateRelatedInformation1.setDtOfSgntr(datatypeFactory.newXMLGregorianCalendar(bankOrderLine.getPartner().getActiveUmr().getMandateSignatureDate().toString("yyyy-MM-dd")));
                    /*
            ...
            // mandateRelatedInformation1.setAmdmntInd(???);
                     ...
                     */
            // AmendmentInformationDetails1 amendmentInformationDetails1 = factory.createAmendmentInformationDetails1();
            ...
            BranchAndFinancialInstitutionIdentification3 branchAndFinancialInstitutionIdentification3 = factory.createBranchAndFinancialInstitutionIdentification3();
            FinancialInstitutionIdentification5Choice financialInstitutionIdentification5Choice = factory.createFinancialInstitutionIdentification5Choice();
            financialInstitutionIdentification5Choice.setBIC(bankOrderLine.getReceiverBankDetails().getBank().getCode()); // BIC
            branchAndFinancialInstitutionIdentification3.setFinInstnId(financialInstitutionIdentification5Choice);
             ...
             */
            AccountIdentification3Choice accountIdentification3Choice = factory.createAccountIdentification3Choice();
            accountIdentification3Choice.setIBAN(bankOrderLine.getReceiverBankDetails().getIban());
            CashAccount7 cashAccount7 = factory.createCashAccount7();
            cashAccount7.setId(accountIdentification3Choice);
            ...
            directDebitTransactionInformation1.setRmtInf(remittanceInformation1);
                 ...
                 */
                // StructuredRemittanceInformation6 structuredRemittanceInformation6 = factory.createStructuredRemittanceInformation6();

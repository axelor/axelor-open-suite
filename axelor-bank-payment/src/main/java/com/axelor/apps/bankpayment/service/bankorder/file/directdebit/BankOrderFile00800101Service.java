...
public class BankOrderFile00800101Service extends BankOrderFileService {
   ...
   * @throws DatatypeConfigurationException
   */
  private void createGrpHdr(GroupHeader1 groupHeader, PartyIdentification8 creditor)
      throws DatatypeConfigurationException {
   ...
   * @throws AxelorException
   */
  private void createDrctDbtTxInf(
    ...
    for (BankOrderLine bankOrderLine : bankOrderLineList) {
       ...
       */
      mandateRelatedInformation1.setMndtId(
          bankOrderLine.getPartner().getActiveUmr().getUmrNumber());
      /*
      ...
      genericIdentification4.setId(
          Beans.get(AccountConfigBankPaymentService.class)
              .getIcsNumber(senderCompany.getAccountConfig()));
      ...
      FinancialInstitutionIdentification5Choice financialInstitutionIdentification5Choice =
          factory.createFinancialInstitutionIdentification5Choice();
      financialInstitutionIdentification5Choice.setBIC(
          bankOrderLine.getReceiverBankDetails().getBank().getCode()); // BIC
      branchAndFinancialInstitutionIdentification3.setFinInstnId(
          financialInstitutionIdentification5Choice);

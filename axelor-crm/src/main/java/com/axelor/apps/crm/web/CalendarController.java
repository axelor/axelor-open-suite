...
public class CalendarController {
  ...
  public void exportCalendar(ActionRequest request, ActionResponse response)
      throws IOException, ParserException, ValidationException, ObjectStoreException,
          ObjectNotFoundException, ParseException {
  ...
  public void testConnect(ActionRequest request, ActionResponse response) throws Exception {
    ...
    if (calendarService.testConnect(cal)) response.setValue("isValid", true);
    else response.setAlert("Login and password do not match.");
  }
  ...
  public void synchronizeCalendar(ActionRequest request, ActionResponse response)
      throws MalformedURLException, SocketException, ObjectStoreException, ObjectNotFoundException,
          ConstraintViolationException, ICalendarException, InvalidKeyException,

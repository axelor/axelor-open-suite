...
public class ControlTypeFieldController {
  ...
  /**
   * The type decides in which column a value is stored. Changing it once values exist would make
   * every stored value unreadable, so it is frozen as soon as the field is used.
   */

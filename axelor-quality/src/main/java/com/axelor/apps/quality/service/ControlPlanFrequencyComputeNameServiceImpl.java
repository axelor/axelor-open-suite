...
public class ControlPlanFrequencyComputeNameServiceImpl
    implements ControlPlanFrequencyComputeNameService {

  @Override
  public String computeName(ControlPlanFrequency controlPlanFrequency) {
    ...
    return String.format(
        ...
        controlPlanFrequency.getSampleQtyUnit().getName(),
        "each",
        controlPlanFrequency.getSampleFrequency().stripTrailingZeros().toPlainString(),
        controlPlanFrequency.getSampleFrequencyUnit().getName());
  }
}

...
public class ControlPlanFrequencyManagementRepository extends ControlPlanFrequencyRepository {
  ...
  @Inject
  public ControlPlanFrequencyManagementRepository(
  ...
  @Override
  public ControlPlanFrequency save(ControlPlanFrequency controlPlanFrequency) {
    controlPlanFrequency.setName(
        controlPlanFrequencyComputeNameService.computeName(controlPlanFrequency));
    return super.save(controlPlanFrequency);
  }
}

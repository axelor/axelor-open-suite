...
* Update studio dependency to 3.4.10
...
* Tracking number search: fixed error on select of product or tracking number.
...
[8.3.22]: https://github.com/axelor/axelor-open-suite/compare/v8.3.21...v8.3.22

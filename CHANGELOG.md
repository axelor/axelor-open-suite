...
* Update studio dependency to 3.5.9
...
* Business Project: fixed an issue where the project closing control checked for pending receptions even when supplier arrivals management on purchase orders was disabled.
* Invoice: fixed project not being set on invoice lines when generating an advance payment invoice.
* Business Project: fixed issues on financial data when changing assigned user and link invoice to sale order.
...
Added AppSupplychainService to BusinessProjectClosingControlServiceImpl contructor
...
* Move line: fixed missing project on analytic move lines generated during invoicing business project.
...
* Project task: added help tooltips on the percentage dashlets in the time follow-up panel.
* Business project: fixed an error when trying to choose an analytic distribution template.
...
* Update Axelor Message to 3.2.4 and Axelor Utils to 3.4.6.
...
[8.4.21]: https://github.com/axelor/axelor-open-suite/compare/v8.4.20...v8.4.21
[8.4.20]: https://github.com/axelor/axelor-open-suite/compare/v8.4.19...v8.4.20

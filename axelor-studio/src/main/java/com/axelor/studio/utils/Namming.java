...
public class Namming {
  ...
  // Java Keywords
  private static final List<String> RESERVED_JAVA =
      Arrays.asList(
          new String[] {
            "abstract",
            "assert",
  ...
  // PostgreSQL 9.x
  private static final List<String> RESERVED_POSTGRESQL =
      Arrays.asList(
          new String[] {
            "all",
            "analyse",
  ...
  private static final List<String> RESERVED_MYSQL =
      Arrays.asList(
          new String[] {
            "accessible",
            "add",
  ...
  // Oracle
  private static final List<String> RESERVED_ORACLE =
      Arrays.asList(
          new String[] {
            "access",
            "add",

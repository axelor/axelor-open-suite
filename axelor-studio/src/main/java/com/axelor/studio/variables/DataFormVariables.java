...
public interface DataFormVariables {
  ...
  static final String FILE_INPUT =
      "<div class='col-6 top-buffer'><label>%s &nbsp;</label><br><input type='file' name='%s' accept='%s' onChange='loadFile(event)' %s/><img style='display:none' id='%s' class='img-input'/></div><br>\n";

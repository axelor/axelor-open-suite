...
public class ViewBuilderService {
  ...
  @Inject private RightManagementService rightMgmtService;
  ...
  @Inject private ReportBuilderService reportBuilderService;
  ...
  /**
   * Method to process ViewBuilder according to its type. It will call method to create view xml and
   * generate MetaView.
   *
   * @param model Name of model.
   * @param viewBuilders List of ViewBuilders to process.
   * @throws JAXBException Xml processing exception
    ...
    for (ViewBuilder viewBuilder : viewBuilders) {
      ...
      switch (viewBuilder.getViewType()) {
        ...
        case "chart":
          ...
          ActionRecord actionRecord = chartBuilderService.getOnNewAction();

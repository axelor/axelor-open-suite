...
public class FieldImporter {
  ...
  public MetaField importField(
    ...
    translationService.addTranslation(
        basic[3], row[CommonService.TITLE_FR], "fr", metaModule.getName());
  ...
  private void validateFieldName(String name, int rowNum, String model) throws AxelorException {
    ...
    if (Strings.isNullOrEmpty(name)) {
      throw new AxelorException(
          I18n.get("No title or name for field row number: %s, model: %s"), 1, rowNum + 1, model);
    }
  ...
  private MetaField setSelectionField(
      String[] row, int rowNum, String modelName, MetaField field, MetaModule module)
      throws AxelorException {
  ...
  private String[] getSelection(String[] row, int rowNum, String modelName, String fieldName)
      throws AxelorException {
    ...
    if (Strings.isNullOrEmpty(selection)) {
      throw new AxelorException(
          I18n.get("Blank selection for object: %s, row: %s"), 1, modelName, rowNum + 1);
    }

...
public class ModelImporter {
  ...
  @Inject private FieldImporter fieldImporter;
  ...
  public void importModel(
      ImporterService importerService, String[] row, int rowNum, MetaModule metaModule)
  ...
  private MetaField addField(
      String[] basic, String[] row, int rowNum, MetaModel model, MetaModule metaModule)
      throws AxelorException {

    Integer sequence = importerService.getFieldSeq(model.getId());
    MetaField metaField =
        fieldImporter.importField(row, rowNum, basic, model, metaModule, sequence);

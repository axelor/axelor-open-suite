...
public class GridBuilderService {
  ...
  /**
   * Method extract non field items like button from grid items and put in itemMap.
   *
   * @param itemMap AbstractWidget map with index of widget in grid as key and widget as value
   * @param items GridView items.
   */
   ...
   *
   * @param itemMap Map of existing non field view items of parent grid view.
   * @param grid GridView to update.
   * @param viewFields ViewFields of ViewBuilder.
   */
  private void addItems(
      Map<Integer, AbstractWidget> itemMap, GridView grid, List<ViewItem> viewItems) {

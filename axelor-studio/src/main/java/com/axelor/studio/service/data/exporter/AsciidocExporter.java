...
public class AsciidocExporter {
  ...
  private static final List<String> COMMENT_TYPES =
      Arrays.asList(new String[] {"tip", "general", "warn"});

  private static final List<String> ASCIIDOC_TYPES =
      Arrays.asList(new String[] {"TIP", "NOTE", "WARNING"});
  ...
  public MetaFile export(MetaFile input, DataReader reader, String lang, String name)
      ...
      for (String key : reader.getKeys()) {
        ...
        for (int ind = 1; ind < totalLines; ind++) {
          ...
          if (type != null) {
            ...
            if (!Strings.isNullOrEmpty(menu) && type.equals("general")) {

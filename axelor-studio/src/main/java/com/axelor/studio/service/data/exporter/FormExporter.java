...
public class FormExporter {
  ...
  @Inject private DashboardExporter dashboardExporter;

  private ExporterService exporterService;

  public List<String[]> export(
      ExporterService exporterService, MetaView formView, List<String> grid) throws JAXBException {
  ...
  private String processField(
    ...
    if (target != null && values[CommonService.TYPE] != null) {
      ...
      values[CommonService.TYPE] =
          values[CommonService.TYPE] + "(" + targets[targets.length - 1] + ")";
    }
    ...
    if (Strings.isNullOrEmpty(values[CommonService.TYPE])) {
      ...
      values[CommonService.TYPE] =
          getType(values[CommonService.TYPE], field.getWidget(), values[CommonService.SELECT]);
    }
  ...
  private String processPanelRelated(
    ...
    values[CommonService.IF_MODULE] =
        ExporterService.getModuleToCheck(panelRelated, (String) extra[3]);
    ...
    if (property != null) {
      ...
      log.debug(
          ...
          values[CommonService.NAME],
          values[CommonService.MODEL]);
    }

    values[CommonService.TITLE_FR] =
        translationService.getTranslation(values[CommonService.TITLE], "fr");
  ...
  private String processDashlet(
    ...
    String[] values =
        dashboardExporter.processDashlet(dashlet, module, model, view, mapper, (String) extra[3]);

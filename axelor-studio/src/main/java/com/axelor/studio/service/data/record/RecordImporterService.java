...
public class RecordImporterService {
  ...
  @Inject private FormatValidator formatValidator;
  ...
  public void importRecords(DataReader reader, MetaFile inputFile, int preference)
  ...
  private void processRefField(
      Property property, Model obj, Map<String, String> refData, List<String> cleared, int index) {

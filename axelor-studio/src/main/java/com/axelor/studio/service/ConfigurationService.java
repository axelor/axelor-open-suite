...
/**
 * Service provide configuration support for studio. It will check build directory path and create
...
public class ConfigurationService {
    ...
    try {
      ...
      if (module == null) {
        ...
        throw new AxelorException(
            I18n.get("No customised module found with name %s"), 1, moduleName);
      }
  ...
  public MetaModule getCustomizedModule(String name) {
    ...
    if (name != null) {
      module =
          moduleRepo.all().filter("self.customised = true and self.name = ?1", name).fetchOne();
    }
  ...
  public void validateFieldName(String name) throws AxelorException {
    ...
    //			throw new AxelorException(I18n.get("Name is either keyword or reserv word. Please use
    // different name"), 1);
    //		}
  }

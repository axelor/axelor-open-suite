...
public class MenuImporter {
      ...
      if (modelName != null) {
        ...
        if (model == null) {
          throw new AxelorException(
              I18n.get("Menu model not found for sheet: %s row: %s"), 1, key, rowNum + 1);
        }
      }
  ...
  public void createMenu(MetaModule module, MetaModel model, String[] row, String key, int rowNum)
    ...
    if (name == null && title == null) {
      throw new AxelorException(
          I18n.get("Menu name and title empty for sheet: %s row: %s"), 1, key, rowNum + 1);
    }
    ...
    MenuBuilder parent =
        menuBuilderRepo
            ...
            .filter(
                ...
                parentName,
                menuBuilder.getMetaModule().getName())
            .fetchOne();
    if (parent != null) {
      ...
      if (parentMenu != null) {
        ...
        throw new AxelorException(
            I18n.get("No parent menu found %s for menu %s"), 1, parentName, menuBuilder.getTitle());
      }
    }

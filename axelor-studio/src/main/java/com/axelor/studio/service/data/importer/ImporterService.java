...
public class ImporterService {
  ...
  @Inject private ModuleImporter moduleImporter;

  @Inject private FormImporter formImporter;

  @Inject private MenuImporter menuImporter;

  @Inject private GridImporter gridImporter;

  @Inject private ModelImporter modelImporter;
  ...
  private void generateGrid(Map<String, MetaModel> clearedModels) throws AxelorException {
    ...
    if (!actionViewMap.isEmpty()) {
      throw new AxelorException(
          I18n.get("Views not found: %s"), 1, formImporter.getViewActionMap().keySet());
    }
  }
    ...
    for (String modelName : models.keySet()) {
      ...
      while (fieldIter.hasNext()) {
        ...
        if (field.getCustomised()
            ...
            && !field.getName().equals("wkfStatus")) {
  ...
  public void addView(MetaModel model, String[] basic, String[] row, int rowNum, MetaField field)
      throws AxelorException {

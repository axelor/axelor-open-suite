...
public class ValidatorService {
  ...
  private boolean validateField(String[] row, String model, String key, int rowNum)
      throws IOException {
  ...
  private boolean validateName(
      String type, String obj, String[] row, String key, int rowNum, boolean consider)
      throws IOException {
  ...
  private boolean checkSelect(String[] row, String key, int rowNum, String type, boolean consider)
      throws IOException {
  ...
  private String validateType(String model, String type, String[] row, String key, int rowNum)
      throws IOException {
  ...
  private boolean checkEvents(String obj, boolean consider, String[] row, String key, int rowNum)
      throws IOException {
  ...
  private void checkInvalid() throws IOException {
    ...
    for (Object[] panel : panelMap.values()) {
      ...
      if (type.equals("panelbook")) {
        addLog(
            I18n.get("Panelbook must follow by paneltab"), (String) panel[1], (Integer) panel[2]);
      }
      if (panel.length == 2 && type.startsWith("panel")) {
        addLog(
            I18n.get("Panel must contain items or sub panels"),
            (String) panel[1],
            (Integer) panel[2]);
      }
    }
  ...
  private void validateView(
      String type, String model, String reference, String[] row, String key, int rowNum)
      throws IOException {
  ...
  private boolean checkFormula(boolean consider, String[] row, String key, int rowNum)
      throws IOException {

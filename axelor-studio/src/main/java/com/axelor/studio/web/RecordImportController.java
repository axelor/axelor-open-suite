...
public class RecordImportController {
  ...
  @Inject private RecordImportWizardRepository importWizardRepo;

  @Inject private RecordImporterService importService;
  ...
  public void importRecords(ActionRequest request, ActionResponse response) throws IOException {
    ...
    try {
      importService.importRecords(
          reader, importWizard.getImportFile(), importWizard.getImportPreference());

...
public class WkfController {
  ...
  @Inject WkfRepository wkfRepo;

  @Inject WkfDesignerService wkfDesignerService;

  @Inject private ViewLoaderService viewLoaderService;

  @Inject private MetaModelRepository metaModelRepo;

  public void processWorkFlow(ActionRequest request, ActionResponse response) throws Exception {
    ...
    if (node.getWkf().getId() != null) {
      ...
      if (found != null) {
        Map<String, Object> view =
            ActionView.define(I18n.get("Edit Node"))
  ...
  public void onTransitionEdit(ActionRequest request, ActionResponse response) throws Exception {
    ...
    if (found != null) {
      ...
      Map<String, Object> view =
          ActionView.define(I18n.get("Edit Transition"))

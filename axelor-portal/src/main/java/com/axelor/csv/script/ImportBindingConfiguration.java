...
public class ImportBindingConfiguration {

  public static final String IMPORT_LEAD_CONFIG = "import-binding-config.xml";
  public static final String IMPORT_LEAD_CSV = "portal_binding.zip";
  public static final String FILES_DIR = "files";

  private final Logger log = LoggerFactory.getLogger(ImportBindingConfiguration.class);

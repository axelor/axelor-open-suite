...
public class SaleOrderInvoiceService {

	private static final Logger LOG = LoggerFactory.getLogger(SaleOrderInvoiceService.class); 
	...
	@Inject
	private SaleOrderLineTaxService saleOrderLineVatService;
...
//				return null;
	...
	public Invoice generatePerOrderInvoice(SaleOrder saleOrder) throws AxelorException  {
		...
		this.fillSaleOrder(saleOrder, invoice).save();

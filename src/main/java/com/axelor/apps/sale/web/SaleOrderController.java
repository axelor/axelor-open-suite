...
public class SaleOrderController {
	...
	@Inject
	private Provider<SaleOrderStockMoveService> saleOrderStockMoveProvider;
...
//		response.setFlash("Document Created in Your Root Directory");
	...
	public void createStockMoves(ActionRequest request, ActionResponse response) throws AxelorException {
		...
		if(saleOrder.getId() != null) {
			...
			saleOrderStockMoveProvider.get().createStocksMovesFromSaleOrder(SaleOrder.find(saleOrder.getId()));
		}
	}
	...
	public void getLocation(ActionRequest request, ActionResponse response) {
		...
		if(saleOrder != null) {
			...
			Location location = saleOrderProvider.get().getLocation(saleOrder.getCompany());

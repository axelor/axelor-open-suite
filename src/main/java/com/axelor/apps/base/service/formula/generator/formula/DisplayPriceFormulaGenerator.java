...
public class DisplayPriceFormulaGenerator extends AbstractFormulaGenerator {

	@Inject
	public DisplayPriceFormulaGenerator() { super(); }
	...
	protected Map<String, Object> bind() {
		...
		bind.put("klassName","DisplayFormula");
...
//			
//			if (constituent.getDisplayFormula() != null && !constituent.getDisplayFormula().isEmpty()){
//								
//				formulas.put(constituent.getCode().toLowerCase(), decode(constituent.getDisplayFormula()));

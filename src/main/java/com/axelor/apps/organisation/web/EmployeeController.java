...
public class EmployeeController {
	 ...
	 * @return
	 */
	public void showEmployeeConsultant(ActionRequest request, ActionResponse response) {
		...
		if (urlNotExist == null){
			...
			LOG.debug("Impression des informations sur l'employe consultant "+employee.getName()+" "+employee.getFirstName()+" : "+url.toString());

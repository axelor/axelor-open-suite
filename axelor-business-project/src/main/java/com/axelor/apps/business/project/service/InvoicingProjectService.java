...
public class InvoicingProjectService extends InvoicingProjectRepository{
	...
	public List<InvoiceLine> customerChargeBackPurchases(List<InvoiceLine> invoiceLineList,InvoicingProject invoicingProject){
		Partner customer = invoicingProject.getProjectTask().getClientPartner();

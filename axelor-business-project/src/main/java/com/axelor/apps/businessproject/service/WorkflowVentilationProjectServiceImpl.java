...
public class WorkflowVentilationProjectServiceImpl
  ...
  protected void confirmReleasedHoldBackInvoiceLinesVentilation(Invoice invoice) {
    invoice
        ...
        .forEach(
            il -> {
              if (il.getRelatedProjectHoldBackLineInvoiceLine() != null) {
                il.getRelatedProjectHoldBackLineInvoiceLine()
                    .setIsVentilatedReleasedProjectHoldBackLineInvoiceLine(true);
              }
              if (il.getRelatedProjectHoldBackATI() != null) {
                il.getRelatedProjectHoldBackATI().setIsVentilatedProjectHoldBackATI(true);
              }
            });
  }
}

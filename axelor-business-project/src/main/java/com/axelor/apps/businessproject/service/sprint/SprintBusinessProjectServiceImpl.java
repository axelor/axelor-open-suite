...
public class SprintBusinessProjectServiceImpl extends SprintHRServiceImpl {

  @Inject
  public SprintBusinessProjectServiceImpl(
      ProjectTaskRepository projectTaskRepo, ProjectTaskHRService projectTaskHRService) {

    super(projectTaskRepo, projectTaskHRService);
  }

  @Override
  protected void attachTaskToSprint(Sprint sprint, ProjectTask task) {

    if (task.getTimeUnit() == null) {
      return;
    }

    super.attachTaskToSprint(sprint, task);
  }
}

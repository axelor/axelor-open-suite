  ...
  public void compute(ActionRequest request, ActionResponse response) throws AxelorException {
    ...
    try {
      ...
      response.setAttr(
          "priceDiscounted",
          "hidden",
          priceDiscounted.compareTo(purchaseOrderLine.getPrice()) == 0);
      ...
      if (!purchaseOrder.getInAti()) {
        exTaxTotal =
            PurchaseOrderLineServiceImpl.computeAmount(
                ...
                purchaseOrderLineService.computeDiscount(purchaseOrderLine));
        inTaxTotal = exTaxTotal.add(exTaxTotal.multiply(taxRate));
        companyExTaxTotal =
            purchaseOrderLineService.getCompanyExTaxTotal(exTaxTotal, purchaseOrder);
        ...
        companyInTaxTotal =
            purchaseOrderLineService.getCompanyExTaxTotal(inTaxTotal, purchaseOrder);
        companyExTaxTotal =
      ...
      response.setValue(
          ...
          purchaseOrderLineService.getSalePrice(
              purchaseOrder, product, purchaseOrderLine.getPrice()));

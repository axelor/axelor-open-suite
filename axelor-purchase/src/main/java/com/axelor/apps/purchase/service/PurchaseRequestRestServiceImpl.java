...
import com.axelor.apps.purchase.rest.dto.PurchaseRequestLinePostRequest;
...
public class PurchaseRequestRestServiceImpl implements PurchaseRequestRestService {
  ...
  protected void createPurchaseRequestLines(
      List<PurchaseRequestLinePostRequest> purchaseRequestLineList,
      PurchaseRequest purchaseRequest) {
    if (CollectionUtils.isEmpty(purchaseRequestLineList)) {
      return;
    }
    for (PurchaseRequestLinePostRequest purchaseRequestLine : purchaseRequestLineList) {
      ...
      purchaseRequest.addPurchaseRequestLineListItem(line);
    }
  }
}

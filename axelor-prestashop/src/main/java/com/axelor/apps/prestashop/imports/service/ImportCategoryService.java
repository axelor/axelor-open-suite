...
public interface ImportCategoryService {
	 ...
	 */
	public BufferedWriter importCategory(BufferedWriter bwImport) throws IOException, PrestaShopWebserviceException, TransformerException, JAXBException, JSONException;
}

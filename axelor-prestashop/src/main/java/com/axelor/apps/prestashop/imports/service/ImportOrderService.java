...
public interface ImportOrderService {
	 ...
	 */
	public BufferedWriter importOrder(BufferedWriter bwImport) throws IOException, PrestaShopWebserviceException, TransformerException, JAXBException, JSONException;
}

...
export const TimeSheetForm = ({ line = {}, date, onClose }) => {
  ...
  const handleSave = async (e) => {
    ...
    if (tsline.toInvoice && !tsline.product) {
    ...
    try {
      ...
      const updatedCounts = {
        ...counts,
        // TODO : why both hourDuration and duration set here
        [date]: {
          ...counts?.[date],
          hoursDuration:
      ...
      toast.success("Time sheet line created Succesfully");
    } catch (error) {
    ...
    <form className={styles.container} onSubmit={handleSave}>
      <div className={styles.wrapper}>
        ...
        <Select
          ...
          fetchOptions={() => fetchProjectTask(tsline.project?.id)}
        ...
        <div className={styles.dateContainer}>
          ...
          <div className={styles.dateWrapper}>
            ...
            {editDate ? (
              ...
              <MaterialIcon
                icon="edit"
                className={styles.enableDateSelection}

...
export const getLeaveListInterval = async (employee, fromDate, toDate) => {
  ...
  // TODO: NEED TO CONFIRM WHAT HAPPEN THIS CASE
  //  CASE 1:  WHEN USER TAKE HALF DAY OF LEAVE.

  // Currently, users are allowed to add time entries when days marked as half-day leave.

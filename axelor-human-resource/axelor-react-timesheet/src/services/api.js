...
const APP_TIMESHEET_MODEL = "com.axelor.studio.db.AppTimesheet";
...
export const fetchTimesheetConfigs = async () => {
  const response = await Service.search(APP_TIMESHEET_MODEL, {
    fields: ["enableActivity"],
  });

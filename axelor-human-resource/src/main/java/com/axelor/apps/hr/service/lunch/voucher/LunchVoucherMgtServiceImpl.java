...
public class LunchVoucherMgtServiceImpl implements LunchVoucherMgtService {
  ...
  protected LunchVoucherMgtLine obtainLineFromEmployee(
      Employee employee, LunchVoucherMgt lunchVoucherMgt) {
    if (CollectionUtils.isNotEmpty(lunchVoucherMgt.getLunchVoucherMgtLineList())) {
  ...
  public int updateStock(
    ...
    int i = 0;
    if (CollectionUtils.isNotEmpty(newLunchVoucherMgtLines)
        && CollectionUtils.isNotEmpty(oldLunchVoucherMgtLines)) {

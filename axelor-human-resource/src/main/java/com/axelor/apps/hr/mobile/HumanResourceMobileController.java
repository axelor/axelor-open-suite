...
public class HumanResourceMobileController {
  ...
  public void insertOrUpdateTSLine(
    ...
    try {
      ...
      if (user != null) {
        ...
        TimesheetLine line;
        Object idO = requestData != null ? requestData.get("id") : null;
        if (idO != null) {
          line =
  ...
  public void getLeaveReason(ActionRequest request, ActionResponse response) {
    try {
      ...
      if (user == null || user.getEmployee() == null) {
        ...
        if (CollectionUtils.isNotEmpty(leaveReasonList)) {
        ...
        String tmpName = "";
        if (CollectionUtils.isNotEmpty(leaveLineList)) {
  ...
  public void getKilometricAllowParam(ActionRequest request, ActionResponse response) {
    ...
    try {
      ...
      if (CollectionUtils.isNotEmpty(employeeVehicleList)) {

...
public class BankOrderCreateServiceHr extends BankOrderCreateService {
	...
	@Inject
	public BankOrderCreateServiceHr(BankOrderRepository bankOrderRepo, BankOrderService bankOrderService, AccountConfigService accountConfigService, BankOrderLineService bankOrderLineService)  {
		super(bankOrderRepo, bankOrderService, accountConfigService, bankOrderLineService);
	}

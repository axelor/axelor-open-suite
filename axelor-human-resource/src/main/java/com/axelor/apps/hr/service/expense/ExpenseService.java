...
public interface ExpenseService {
  ...
  /**
   * Set the expense status to draft.
   *
   * @param expense
   * @throws AxelorException if the expense wasn't refused nor canceled.
   */
  void backToDraft(Expense expense) throws AxelorException;
}

...
public class MoveTemplateService {
  ...
  public void validateMoveTemplateLine(MoveTemplate moveTemplate) {
    ...
    for (MoveTemplateLine line : moveTemplate.getMoveTemplateLineList()) line.setIsValid(true);
  ...
  public List<Long> generateMove(
      MoveTemplate moveTemplate, List<HashMap<String, Object>> dataList) {
    try {
          ...
          if (line.getDebitCreditSelect().equals("0")) {
            ...
            MoveLine moveLine =
                moveLineService.createMoveLine(
                    ...
                    partner,
                    line.getAccount(),
                    moveBalance.multiply(line.getPercentage()).divide(hundred),
                    true,
                    moveDate,
                    moveDate,
                    counter,

...
@XmlType(
    name = "",
    propOrder = {"connectionErrors"})
@XmlRootElement(name = "DimensionRegistryResponse")
public class DimensionRegistryResponse extends SimpleResponseType {
   ...
   *
   * @return possible object is {@link DimensionRegistryConnectionErrorsType }
   */
   ...
   *
   * @param value allowed object is {@link DimensionRegistryConnectionErrorsType }
   */

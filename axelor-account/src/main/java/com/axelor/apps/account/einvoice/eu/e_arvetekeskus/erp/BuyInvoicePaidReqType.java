...
/**
 * Java class for BuyInvoicePaidReqType complex type.
 *
...
@XmlType(
    name = "BuyInvoicePaidReqType",
    propOrder = {"paidInvoice"})
public class BuyInvoicePaidReqType {
   ...
   * there is not a <CODE>set</CODE> method for the paidInvoice property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link PaidInvoiceType }
   */

...
public class MoveAccountingMoveLineAnalyticControlServiceImpl implements MoveAccountingMoveLineAnalyticControlService{
	...
	@Override
	public void checkAuthorizedAnalyticDistributionTemplate(MoveLine moveLine) throws AxelorException {
		Account account = moveLine.getAccount();
        if (account != null
                && !account.getAnalyticDistributionAuthorized()

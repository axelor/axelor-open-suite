...
public class AnalyticMoveLineServiceImpl implements AnalyticMoveLineService {
  ...
  public AnalyticMoveLineServiceImpl(
      GeneralService generalService, AnalyticMoveLineRepository analyticMoveLineRepository) {
  ...
  public List<AnalyticMoveLine> generateLines(
    ...
    if (generalService.getGeneral().getAnalyticDistributionTypeSelect()
        == GeneralRepository.DISTRIBUTION_TYPE_PARTNER) {
      analyticDistributionLineList = this.generateLinesFromPartner(partner, total);
    } else if (generalService.getGeneral().getAnalyticDistributionTypeSelect()
        == GeneralRepository.DISTRIBUTION_TYPE_PRODUCT) {

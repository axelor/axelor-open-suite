...
/**
 * Java class for DimensionRegistryConnectionErrorsType complex type.
 *
...
@XmlType(
    name = "DimensionRegistryConnectionErrorsType",
    propOrder = {"importError"})
public class DimensionRegistryConnectionErrorsType {
   ...
   * there is not a <CODE>set</CODE> method for the importError property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link ImportError }
   */
  ...
  @XmlType(
      name = "",
      propOrder = {"code", "message", "connectionDimFrom", "connectionDimTo"})
  public static class ImportError {
     ...
     *
     * @return possible object is {@link DimensionRegistryConnectionPartType }
     */
     ...
     *
     * @param value allowed object is {@link DimensionRegistryConnectionPartType }
     */

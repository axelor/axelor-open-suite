  ...
  public void reconcilePreconditions(Reconcile reconcile) throws AxelorException {
    ...
    if (debitMoveLine == null || creditMoveLine == null) {
      throw new AxelorException(
          String.format(I18n.get(IExceptionMessage.RECONCILE_1), GeneralServiceImpl.EXCEPTION),
    ...
    if (!creditMoveLineAccount.equals(debitMoveLineAccount)) {
      log.debug(
          ...
          creditMoveLineAccount,
          debitMoveLineAccount);
      throw new AxelorException(
          String.format(
              ...
              GeneralServiceImpl.EXCEPTION,
              debitMoveLine.getName(),
              debitMoveLineAccount.getLabel(),
              creditMoveLine.getName(),
              creditMoveLineAccount.getLabel()),
          IException.CONFIGURATION_ERROR);
    }

...
/**
 * Java class for AdditionalDocumentRecordEN complex type.
 *
...
@XmlType(
    name = "AdditionalDocumentRecordEN",
    propOrder = {"type", "number", "date", "name", "url", "file"})
public class AdditionalDocumentRecordEN {
  ...
  @XmlType(
      name = "",
      propOrder = {"filename", "fileMimeCode", "binaryObject"})

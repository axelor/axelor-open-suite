...
/**
 * Java class for ItemEntryENType complex type.
 *
...
public class ItemEntryENType {
   ...
   *
   * @return possible object is {@link ItemAdditionalId }
   */
   ...
   *
   * @param value allowed object is {@link ItemAdditionalId }
   */
   ...
   * there is not a <CODE>set</CODE> method for the itemClassification property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link ItemClassification }
   */
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link AdditionENType }
   */
   ...
   *
   * @return possible object is {@link ItemPriceInfo }
   */
   ...
   *
   * @param value allowed object is {@link ItemPriceInfo }
   */

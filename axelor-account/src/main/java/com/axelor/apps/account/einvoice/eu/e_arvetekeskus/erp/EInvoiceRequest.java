...
@XmlType(
    name = "",
    propOrder = {"eInvoice", "pdfAttachment"})
...
public class EInvoiceRequest {
  ...
  /**
   * Estonian e-invoice version 1.0. More info available at
   ...
   * there is not a <CODE>set</CODE> method for the pdfAttachment property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link Base64FileType }
   */

...
public class BatchReimbursementExport extends BatchStrategy {
  ...
  protected void process() {
    if (!end) {
      ...
      switch (batch.getAccountingBatch().getReimbursementExportTypeSelect()) {
        case AccountingBatchRepository.REIMBURSEMENT_EXPORT_TYPE_GENERATE:
          this.runCreateReimbursementExport(company, fetchLimit);

          break;

        case AccountingBatchRepository.REIMBURSEMNT_EXPORT_TYPE_EXPORT:
          this.runReimbursementExportProcess(company, fetchLimit);
  ...
  public void runCreateReimbursementExport(Company company, int fetchLimit) {
  ...
  public void runReimbursementExportProcess(Company company, int fetchLimit) {

...
/**
 * Java class for CostReportExportRequestType complex type.
 *
...
@XmlType(
    name = "CostReportExportRequestType",
    propOrder = {"state"})
public class CostReportExportRequestType {
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link CostReportStateType }
   */

...
public class FixedAssetServiceImpl implements FixedAssetService {
  ...
  protected FixedAssetLine disposal(
      ...
      throws AxelorException {
    FixedAssetLineService fixedAssetLineService = fixedAssetLineServiceFactory.getFixedAssetService(
            fixedAssetLineTypeSelect);
  ...
  protected void checkDisposalDates(
    ...
    if (previousPlannedLine != null && previousPlannedLine.getDepreciationDate() != null
  ...
  protected FixedAssetLine computeCession(
    ...
    String depreciationPlanSelect = fixedAsset
            .getDepreciationPlanSelect();
    if (correspondingFixedAssetLine != null && StringUtils.notEmpty(depreciationPlanSelect)
    ...
    if (StringUtils.notEmpty(depreciationPlanSelect) && depreciationPlanSelect
  ...
  protected void checkCessionDates(
    ...
    if (fixedAssetLine.isPresent() && fixedAssetLine.get().getDepreciationDate() != null
    ...
    FixedAssetDerogatoryLine lastRealizedDerogatoryLine =
        fixedAssetDerogatoryLineList.stream()
            .filter(line -> line.getStatusSelect() == FixedAssetLineRepository.STATUS_REALIZED)
                .sorted(Comparator.comparing(FixedAssetDerogatoryLine::getDepreciationDate, Comparator.nullsFirst(Comparator.reverseOrder())))
            .findFirst()
            .orElse(null);
    fixedAssetDerogatoryLineList.sort(
    ...
    FixedAssetDerogatoryLine firstPlannedDerogatoryLine =
        fixedAssetDerogatoryLineList.stream()
            .filter(line -> line.getStatusSelect() == FixedAssetLineRepository.STATUS_PLANNED)
                .sorted(Comparator.comparing(FixedAssetDerogatoryLine::getDepreciationDate, Comparator.nullsFirst(Comparator.naturalOrder())))
                .findFirst()
            .orElse(null);
  ...
  public FixedAsset computeDisposal(
    ...
    if (transferredReason == FixedAssetRepository.TRANSFERED_REASON_PARTIAL_CESSION) {
      ...
      for(Integer typeSelect : typeSelectList) {
        depreciationFixedAssetLine = disposal(
                disposalDate,
                disposalAmount,
                fixedAsset,
                transferredReason,
  ...
  public void checkFixedAssetBeforeDisposal(
      ...
      TaxLine saleTaxLine)
      throws AxelorException {
    if (disposalDate != null && Stream.of(
            ...
            .anyMatch(
                fixedAssetLine ->
                    fixedAssetLine.getStatusSelect() != FixedAssetLineRepository.STATUS_REALIZED && fixedAssetLine.getDepreciationDate() != null

...
public class PaymentScheduleServiceImpl implements PaymentScheduleService {
  ...
  public PaymentSchedule createPaymentSchedule(
    ...
    paymentSchedule.setPaymentScheduleSeq(this.getPaymentScheduleSequence(company,paymentSchedule));
   ...
   */
  @Override
  public String getPaymentScheduleSequence(Company company,PaymentSchedule paymentSchedule) throws AxelorException {
    String seq =

  ...
  public List<String[]> importCFONB(
    ...
    if (generalService.getGeneral().getTransferAndDirectDebitInterbankCode() == null) {
      throw new AxelorException(
          String.format(I18n.get(IExceptionMessage.CFONB_IMPORT_1), GeneralServiceImpl.EXCEPTION),
    ...
    while (this.importFile != null && this.importFile.size() != 0) {
      ...
      if (headerCFONB == null) {
        throw new AxelorException(
            String.format(
                I18n.get(IExceptionMessage.CFONB_IMPORT_2), GeneralServiceImpl.EXCEPTION, fileName),
            IException.CONFIGURATION_ERROR);
      }
      ...
      if (multiDetailsCFONB.isEmpty()) {
        throw new AxelorException(
            String.format(
                I18n.get(IExceptionMessage.CFONB_IMPORT_3), GeneralServiceImpl.EXCEPTION, fileName),
            IException.CONFIGURATION_ERROR);
      }
      ...
      if (endingCFONB == null) {
        throw new AxelorException(
            String.format(
                I18n.get(IExceptionMessage.CFONB_IMPORT_4), GeneralServiceImpl.EXCEPTION, fileName),
            IException.CONFIGURATION_ERROR);
      }

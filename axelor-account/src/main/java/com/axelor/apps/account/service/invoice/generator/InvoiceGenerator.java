...
public abstract class InvoiceGenerator {
    ...
    switch (operationType) {
      ...
      default:
        throw new AxelorException(
            String.format(
                I18n.get(IExceptionMessage.INVOICE_GENERATOR_1), GeneralServiceImpl.EXCEPTION),
  ...
  protected Invoice createInvoiceHeader() throws AxelorException {
    ...
    if (partner == null) {
      throw new AxelorException(
          String.format(
              I18n.get(IExceptionMessage.INVOICE_GENERATOR_2), GeneralServiceImpl.EXCEPTION),
          IException.MISSING_FIELD);
    }
    ...
    if (paymentCondition == null) {
      throw new AxelorException(
          String.format(
              I18n.get(IExceptionMessage.INVOICE_GENERATOR_3), GeneralServiceImpl.EXCEPTION),
          IException.MISSING_FIELD);
    }
    ...
    if (paymentMode == null) {
      throw new AxelorException(
          String.format(
              I18n.get(IExceptionMessage.INVOICE_GENERATOR_4), GeneralServiceImpl.EXCEPTION),
          IException.MISSING_FIELD);
    }
    ...
    if (mainInvoicingAddress == null && partner.getIsCustomer()) {
      throw new AxelorException(
          String.format(
              I18n.get(IExceptionMessage.INVOICE_GENERATOR_5), GeneralServiceImpl.EXCEPTION),
          IException.MISSING_FIELD);
    }
    ...
    if (currency == null) {
      throw new AxelorException(
          String.format(
              I18n.get(IExceptionMessage.INVOICE_GENERATOR_6), GeneralServiceImpl.EXCEPTION),
          IException.MISSING_FIELD);
    }
  ...
  public void computeInvoice(Invoice invoice) throws AxelorException {
    ...
    for (InvoiceLineTax invoiceLineTax : invoice.getInvoiceLineTaxList()) {
      ...
      invoice.setCompanyInTaxTotal(
          invoice.getCompanyInTaxTotal().add(invoiceLineTax.getCompanyInTaxTotal()));
    }

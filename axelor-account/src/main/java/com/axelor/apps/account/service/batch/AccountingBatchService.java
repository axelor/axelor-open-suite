...
public class AccountingBatchService extends AbstractBatchService {
  ...
  public Batch run(Model batchModel) throws AxelorException {
    ...
    switch (accountingBatch.getActionSelect()) {
      ...
      case AccountingBatchRepository.ACTION_CLOSE_OR_OPEN_THE_ANNUAL_ACCOUNTS:
        ...
        break;
      case AccountingBatchRepository.ACTION_GENERATE_RETAIL_INVOICE_MOVE:
        batch = closeAnnualAccounts(accountingBatch);
        break;
      default:
  ...
  public Batch generateRetailInvoiceMove(AccountingBatch accountingBatch) {
    return Beans.get(BatchGenerateRetailInvoiceMove.class).run(accountingBatch);
  }
}

...
/**
 * Java class for SaleInvoiceExportReqType complex type.
 *
...
public class SaleInvoiceExportReqType {
   ...
   * there is not a <CODE>set</CODE> method for the state property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link SaleInvoiceStateType }
   */
   ...
   *
   * @return possible object is {@link InvoiceFormatType }
   */
   ...
   *
   * @param value allowed object is {@link InvoiceFormatType }
   */

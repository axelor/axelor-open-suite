...
public class CfonbExportService {
   ...
   * @param dateTime La date permettant de déterminer le nom du fichier créé
   * @param destinationFolder Le répertoire de destination
   * @param prefix Le préfix utilisé
   * @throws AxelorException
   */
  private void createCFONBFile(
      List<String> cFONB, DateTime dateTime, String destinationFolder, String prefix)
      throws AxelorException {
    ...
    try {
      ...
      throw new AxelorException(
          String.format(
              I18n.get(IExceptionMessage.CFONB_EXPORT_2), GeneralServiceImpl.EXCEPTION, e),
          IException.CONFIGURATION_ERROR);
    }
  }

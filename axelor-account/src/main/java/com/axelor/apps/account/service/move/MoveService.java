...
public class MoveService {
  ...
  public void createMoveUseExcessPayment(Invoice invoice) throws AxelorException {
    ...
    if (accountConfig.getAutoReconcileOnInvoice()) {
      ...
      creditMoveLineList.addAll(
          moveExcessPaymentService.getExcessPayment(
              invoice,
              moveToolService.getCustomerAccount(
                  invoice.getPartner(), company, InvoiceToolService.isPurchase(invoice))));
    }
      ...
      // trop-perçus
        ...
        if (move != null) {
          ...
          MoveLine creditMoveLine =
              moveLineService.createMoveLine(move, partner, account, amount, false, today, 1, null);
  ...
  public Move createMoveUseDebit(
    ...
    if (oDmove != null) {
      ...
      MoveLine debitMoveLine =
          moveLineService.createMoveLine(oDmove, partner, account, amount, true, today, 1, null);
      ...
      paymentService.createExcessPaymentWithAmount(
          debitMoveLines, amount, oDmove, 2, partner, company, null, account, today);

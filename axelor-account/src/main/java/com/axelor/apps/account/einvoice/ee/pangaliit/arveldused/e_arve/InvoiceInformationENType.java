...
/**
 * Java class for InvoiceInformationENType complex type.
 *
...
public class InvoiceInformationENType {
   ...
   *
   * @return possible object is {@link VATPointDate }
   */
   ...
   *
   * @param value allowed object is {@link VATPointDate }
   */
   ...
   * there is not a <CODE>set</CODE> method for the precedingInvoice property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link AdditionalDocumentRecordEN }
   */
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the additionalDocument property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   *
   * @return possible object is {@link ProcessControl }
   */
   ...
   *
   * @param value allowed object is {@link ProcessControl }
   */
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the invoiceNote property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link InvoiceNote }
   */
  ...
  @XmlType(
      name = "",
      propOrder = {"businessProcessType", "specificationId"})
  ...
  @XmlType(
      name = "",
      propOrder = {"vatPointDate", "vatPointDateCode"})

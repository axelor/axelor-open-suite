...
public class ExampleCustomContentElementForENInvoice {
   ...
   *
   * @return possible object is {@link InvoiceInformationENType }
   */
   ...
   *
   * @param value allowed object is {@link InvoiceInformationENType }
   */
   ...
   *
   * @return possible object is {@link InvoiceSumGroupENType }
   */
   ...
   *
   * @param value allowed object is {@link InvoiceSumGroupENType }
   */
   ...
   *
   * @return possible object is {@link PaymentInfoENType }
   */
   ...
   *
   * @param value allowed object is {@link PaymentInfoENType }
   */
   ...
   *
   * @return possible object is {@link PartyENType }
   */
   ...
   *
   * @param value allowed object is {@link PartyENType }
   */
   ...
   *
   * @return possible object is {@link AdditionENType }
   */
   ...
   *
   * @param value allowed object is {@link AdditionENType }
   */
   ...
   *
   * @return possible object is {@link ItemEntryENType }
   */
   ...
   *
   * @param value allowed object is {@link ItemEntryENType }
   */
   ...
   *
   * @return possible object is {@link MailAddressENType }
   */
   ...
   *
   * @param value allowed object is {@link MailAddressENType }
   */
   ...
   *
   * @return possible object is {@link VATENType }
   */
   ...
   *
   * @param value allowed object is {@link VATENType }
   */

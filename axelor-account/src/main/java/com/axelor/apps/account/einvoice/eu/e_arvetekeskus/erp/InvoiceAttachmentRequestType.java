...
/**
 * Java class for InvoiceAttachmentRequestType complex type.
 *
...
@XmlType(
    name = "InvoiceAttachmentRequestType",
    propOrder = {"invoiceId"})
public class InvoiceAttachmentRequestType {
   ...
   * there is not a <CODE>set</CODE> method for the invoiceId property.
   *

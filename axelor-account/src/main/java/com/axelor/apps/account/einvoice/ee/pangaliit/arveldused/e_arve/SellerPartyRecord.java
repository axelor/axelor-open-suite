...
/**
 * Java class for SellerPartyRecord complex type.
 *
...
public class SellerPartyRecord {
   ...
   *
   * @return possible object is {@link ContactDataRecord }
   */
   ...
   *
   * @param value allowed object is {@link ContactDataRecord }
   */
   ...
   * there is not a <CODE>set</CODE> method for the accountInfo property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link AccountDataRecord }
   */

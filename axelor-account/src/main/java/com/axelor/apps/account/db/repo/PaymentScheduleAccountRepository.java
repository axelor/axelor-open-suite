...
public class PaymentScheduleAccountRepository extends PaymentScheduleRepository {
  ...
  public PaymentSchedule save(PaymentSchedule paymentSchedule) {
      PaymentSchedule savedPaymentSchedule = super.save(paymentSchedule);
      try {
          if (Strings.isNullOrEmpty(savedPaymentSchedule.getPaymentScheduleSeq())) {
              String num =
              ...
              if (Strings.isNullOrEmpty(num)) {
                  ...
                  savedPaymentSchedule.setPaymentScheduleSeq(num);
              }
          }

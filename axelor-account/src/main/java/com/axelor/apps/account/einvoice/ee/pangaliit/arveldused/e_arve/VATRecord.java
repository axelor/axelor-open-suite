...
/**
 * Java class for VATRecord complex type.
 *
...
@XmlType(
    name = "VATRecord",
    propOrder = {"sumBeforeVAT", "vatRate", "vatSum", "currency", "sumAfterVAT", "reference"})
public class VATRecord {
   ...
   *
   * @return possible object is {@link ExtensionRecord }
   */
   ...
   *
   * @param value allowed object is {@link ExtensionRecord }
   */

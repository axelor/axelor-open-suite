...
/**
 * Java class for CompanyStatusRequestType complex type.
 *
...
public class CompanyStatusRequestType {
   ...
   * there is not a <CODE>set</CODE> method for the regNumber property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link RegNumber }
   */
  ...
  public static class RegNumber {
    ...
    @Override
    public String toString() {
      return "RegNumber{" + "value='" + value + '\'' + ", countryCode='" + countryCode + '\'' + '}';
    }
  }
}

...
//			}
	...
	/**
	 * Method to create a sender record for internationnal transfer AFB320
	 * @param company
	 * @param dateTime
	 * @return
	 * @throws AxelorException
	...
	private String createSenderRecord() throws AxelorException  {
		...
		senderRecord += cfonbToolService.createZone("5", "", cfonbToolService.STATUS_MANDATORY, cfonbToolService.FORMAT_ALPHA_NUMERIC, 35);  //TODO add it on partner and company
	...
	/**
	 * Method to create a recipient record for internationnal transfer AFB320
	 * @param company
	 * @param dateTime
	 * @return
	 * @throws AxelorException
	...
	private String createDetailRecord(BankOrderLine bankOrderLine) throws AxelorException  {
		...
		detailRecord += cfonbToolService.createZone("10", bankOrderLine.getReceiverReference(), cfonbToolService.STATUS_MANDATORY, cfonbToolService.FORMAT_ALPHA_NUMERIC, 16);
		...
		detailRecord += cfonbToolService.createZone("19", "OUR", cfonbToolService.STATUS_MANDATORY, cfonbToolService.FORMAT_NUMERIC, 2); //TODO option
...
//			zone25 = bankOrderLine.getCurrency(); //TODO
	...
	/**
	 * Method to create a dependent receiver bank record for internationnal transfer AFB320
	 * @param company
	 * @param dateTime
	 * @return
	 * @throws AxelorException
	...
	private String createDependentReceiverBankRecord(BankOrderLine bankOrderLine) throws AxelorException  {
		...
		totalRecord += cfonbToolService.createZone("7", bankOrderSeq, cfonbToolService.STATUS_OPTIONAL, cfonbToolService.FORMAT_ALPHA_NUMERIC, 2);  //TODO update bank details model
	...
	//TODO enregistrement complémentaire
	...
	private String createTotalRecord() throws AxelorException  {
		...
		totalRecord += cfonbToolService.createZone("5", "", cfonbToolService.STATUS_NOT_USED, cfonbToolService.FORMAT_ALPHA_NUMERIC, 4*35);  //TODO add it on partner and company

...
public class BatchCloseAnnualAccounts extends BatchStrategy {
  ...
  protected void generateResultMove(BigDecimal amount) throws AxelorException {
    ...
    if (move.getJournal() != null
        ...
        && accountingBatch.getGeneratedMoveStatusSelect() == MoveRepository.STATUS_SIMULATED
    ...
    if (accountingBatch.getGeneratedMoveStatusSelect() == MoveRepository.STATUS_ACCOUNTED) {
      moveValidateService.accounting(move);
    }
  }

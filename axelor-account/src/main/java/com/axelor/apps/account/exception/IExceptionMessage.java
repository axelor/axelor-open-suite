...
public interface IExceptionMessage {
  ...
  static final String MOVE_LINE_REPORT_1 = /*$$(*/
      "%s : Error : You must configure an account reporting sequence for the company %s" /*)*/;

  static final String MOVE_LINE_REPORT_2 = /*$$(*/
  ...
  static final String MOVE_LINE_3 = /*$$(*/
      "Product missing on invoice line, invoice : %s (company : %s)" /*)*/;
  ...
  static final String RECONCILE_2 = /*$$(*/
      "%s : Reconciliation : Selected moves lines must concerned the same account." /*)*/;
  ...
  static final String BATCH_REIMBURSEMENT_4 = /*$$(*/
      "Reporting to reimboursement's export :" /*)*/;
  ...
  static final String ACCOUNT_CONFIG_37 = /*$$(*/
      "%s : You must configure a reminder tab for the company %s" /*)*/;
  ...
  static final String REMINDER_ACTION_3 = /*$$(*/
      "%s : Letter template missing for reminder matrix %s (Partner %s, Level %s)." /*)*/;

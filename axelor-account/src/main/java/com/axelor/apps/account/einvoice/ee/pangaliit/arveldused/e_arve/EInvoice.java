...
@XmlType(
    name = "",
    propOrder = {"header", "invoice", "footer"})
...
public class EInvoice {
   ...
   * there is not a <CODE>set</CODE> method for the invoice property.
   *
   ...
   *
   * @return possible object is {@link Footer }
   */
   ...
   *
   * @param value allowed object is {@link Footer }
   */

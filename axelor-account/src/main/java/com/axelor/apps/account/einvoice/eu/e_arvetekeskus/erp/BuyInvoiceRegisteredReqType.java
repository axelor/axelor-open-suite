...
/**
 * Java class for BuyInvoiceRegisteredReqType complex type.
 *
...
@XmlType(
    name = "BuyInvoiceRegisteredReqType",
    propOrder = {"registeredInvoice"})
public class BuyInvoiceRegisteredReqType {
   ...
   * there is not a <CODE>set</CODE> method for the registeredInvoice property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link RegisteredInvoiceType }
   */

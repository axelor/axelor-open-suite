...
public class InvoiceManagementRepository extends InvoiceRepository {
  ...
  @Inject
  public InvoiceManagementRepository(SubrogationReleaseRepository subrogationReleaseRepository) {
    ...
    try {
      ...
      if (context.get("_model") != null
        ...
        if (context.get("id") != null) {
          ...
          SubrogationRelease subrogationRelease = subrogationReleaseRepository.find(id);

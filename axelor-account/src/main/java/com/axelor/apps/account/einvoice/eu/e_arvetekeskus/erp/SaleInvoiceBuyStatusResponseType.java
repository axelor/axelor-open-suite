...
/**
 * Java class for SaleInvoiceBuyStatusResponseType complex type.
 *
...
@XmlType(
    name = "SaleInvoiceBuyStatusResponseType",
    propOrder = {"response"})
public class SaleInvoiceBuyStatusResponseType {
   ...
   * there is not a <CODE>set</CODE> method for the response property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link SaleInvoiceBuyStatusType }
   */

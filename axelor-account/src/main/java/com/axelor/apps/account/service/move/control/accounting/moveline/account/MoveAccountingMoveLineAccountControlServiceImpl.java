...
public class MoveAccountingMoveLineAccountControlServiceImpl implements MoveAccountingMoveLineAccountControlService{
	...
	public void checkValidAccount(MoveLine moveLine) throws AxelorException {
	    ...
	    AccountType accountType = moveLine.getAccount() == null ? null : moveLine.getAccount().getAccountType();

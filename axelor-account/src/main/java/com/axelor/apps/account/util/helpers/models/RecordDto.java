...
public class RecordDto {
     ...
     */
    public static List<RecordDto> generateRecordDtoList(List<ChartMonthTurnoverDto> revenueDTO, List<ChartMonthTurnoverDto> costsDTO, List<ChartMonthTurnoverDto> workforceCostsDTO) {

...
/**
 * Java class for PaymentInfoENType complex type.
 *
...
@XmlType(
    name = "PaymentInfoENType",
    propOrder = {"paymentMethodCode", "paymentCardInfo", "paymentAccountName"})
public class PaymentInfoENType {
   ...
   *
   * @return possible object is {@link PaymentCardInfo }
   */
   ...
   *
   * @param value allowed object is {@link PaymentCardInfo }
   */
  ...
  @XmlType(
      name = "",
      propOrder = {"primaryAccountNumber", "paymentCardHolderName"})

...
public class Invoice {
   ...
   *
   * @return possible object is {@link InvoiceParties }
   */
   ...
   *
   * @param value allowed object is {@link InvoiceParties }
   */
   ...
   *
   * @return possible object is {@link InvoiceInformation }
   */
   ...
   *
   * @param value allowed object is {@link InvoiceInformation }
   */
   ...
   * there is not a <CODE>set</CODE> method for the invoiceSumGroup property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link InvoiceSumGroup }
   */
   ...
   *
   * @return possible object is {@link InvoiceItem }
   */
   ...
   *
   * @param value allowed object is {@link InvoiceItem }
   */
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the additionalInformation property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   *
   * @return possible object is {@link AttachmentRecord }
   */
   ...
   *
   * @param value allowed object is {@link AttachmentRecord }
   */
   ...
   *
   * @param value allowed object is {@link PaymentInfo }
   */

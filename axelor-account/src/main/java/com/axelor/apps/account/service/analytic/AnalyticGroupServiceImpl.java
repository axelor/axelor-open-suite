...
public class AnalyticGroupServiceImpl implements AnalyticGroupService {
  ...
  public Map<String, Object> getAnalyticAccountValueMap(AnalyticLine analyticLine, Company company)
    ...
    // Always push the five axes: callers frequently recompute the distribution on the very same
    // line instance beforehand, so comparing against the "previous" value of the line would
    // compare the recomputed value with itself and leave a stale value displayed client side.

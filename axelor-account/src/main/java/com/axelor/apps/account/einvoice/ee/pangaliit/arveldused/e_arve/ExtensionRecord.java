...
/**
 * Java class for ExtensionRecord complex type.
 *
...
@XmlType(
    ...
    propOrder = {"informationName", "informationContent", "customContent"})
public class ExtensionRecord {
   ...
   *
   * @return possible object is {@link CustomContent }
   */
   ...
   *
   * @param value allowed object is {@link CustomContent }
   */

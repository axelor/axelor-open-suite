...
/**
 * Java class for RejectConfirmationRequestType complex type.
 *
...
@XmlType(
    name = "RejectConfirmationRequestType",
    propOrder = {"rejectContent"})
public class RejectConfirmationRequestType {
   ...
   * there is not a <CODE>set</CODE> method for the rejectContent property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link RejectContentType }
   */

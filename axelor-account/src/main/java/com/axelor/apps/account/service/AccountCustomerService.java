...
public class AccountCustomerService {
  ...
  public BigDecimal getBalanceDueReminder(Partner partner, Company company) {
    log.debug(
        "Compute balance due reminder (Partner : {}, Company : {})",
        partner.getName(),
        company.getName());
  ...
  public void updateCustomerAccount(AccountingSituation accountingSituation)
    ...
    accountingSituation.setBalanceDueReminderCustAccount(
        this.getBalanceDueReminder(partner, company));
  ...
  public AccountingSituation updateAccountingSituationCustomerAccount(
    ...
    log.debug(
        "Update customer account (Partner : {}, Company : {}, Update balance : {}, balance due : {}, balance due reminder : {})",
        partner.getName(),
        company.getName(),
        updateCustAccount,
        updateDueCustAccount,
  ...
  public Account getPartnerAccount(Partner partner, Company company, boolean isSupplierInvoice)
    ...
    if (isSupplierInvoice) {
      return this.getSupplierAccount(partner, company);
    } else {
      return this.getCustomerAccount(partner, company);
    }
  }
  ...
  protected Account getSupplierAccount(Partner partner, Company company) throws AxelorException {
    ...
    if (supplierAccount == null) {
      ...
      supplierAccount =
          accountConfigService.getSupplierAccount(accountConfigService.getAccountConfig(company));
    }

...
public class MoveLineExportServiceImpl implements MoveLineExportService {
  ...
  public void updateMoveList(
    ...
    for (Move move : moveList) {
      ...
      this.updateMove(
          ...
          moveLineReportRepo.find(moveLineReport.getId()),
          localDate,
  ...
  public Move updateMove(
      Move move, MoveLineReport moveLineReport, LocalDate localDate, String exportToAgressoNumber) {
  ...
  public String getSaleExportNumber(Company company) throws AxelorException {
    ...
    String exportNumber =
        sequenceService.getSequenceNumber(IAdministration.SALES_INTERFACE, company);
  ...
  public String getRefundExportNumber(Company company) throws AxelorException {
    ...
    String exportNumber =
        sequenceService.getSequenceNumber(IAdministration.REFUND_INTERFACE, company);
    if (exportNumber == null) {
      throw new AxelorException(
          String.format(
  ...
  public String getTreasuryExportNumber(Company company) throws AxelorException {
    ...
    String exportNumber =
        sequenceService.getSequenceNumber(IAdministration.TREASURY_INTERFACE, company);
    if (exportNumber == null) {
      throw new AxelorException(
          String.format(
  ...
  public String getPurchaseExportNumber(Company company) throws AxelorException {
    ...
    String exportNumber =
        sequenceService.getSequenceNumber(IAdministration.PURCHASE_INTERFACE, company);
    if (exportNumber == null) {
      throw new AxelorException(
          String.format(
  ...
  public void exportMoveLineTypeSelect1006(MoveLineReport mlr, boolean replay)
    ...
    String fileName = "detail" + todayTime.toString(DATE_FORMAT_YYYYMMDDHHMMSS) + "ventes.dat";
  ...
  public void exportMoveLineTypeSelect1006FILE1(MoveLineReport moveLineReport, boolean replay)
    ...
    if (replay) {
      dateQueryStr +=
          String.format(
              " AND self.accountingOk = true AND self.moveLineReport = %s", moveLineReport.getId());
    } else {
    ...
    if (moveLineReport.getDateFrom() != null) {
      moveLineQueryStr +=
          String.format(" AND self.date >= '%s'", moveLineReport.getDateFrom().toString());
    }
    if (moveLineReport.getDateTo() != null) {
      moveLineQueryStr +=
          String.format(" AND self.date <= '%s'", moveLineReport.getDateTo().toString());
    }
    if (moveLineReport.getDate() != null) {
      moveLineQueryStr +=
          String.format(" AND self.date <= '%s'", moveLineReport.getDate().toString());
    }
    if (replay) {
      moveQueryStr +=
          String.format(
    ...
    for (LocalDate dt : allDates) {
      ...
      List<Journal> journalList =
          journalRepo
              .all()
              .filter("self.type = ?1 AND self.notExportOk = false", journalType)
              .fetch();
    ...
    String fileName = "entete" + todayTime.toString(DATE_FORMAT_YYYYMMDDHHMMSS) + "ventes.dat";
    String filePath =
  ...
  public void exportMoveLineTypeSelect1007(MoveLineReport moveLineReport, boolean replay)
    ...
    String fileName = "detail" + todayTime.toString(DATE_FORMAT_YYYYMMDDHHMMSS) + "avoirs.dat";
  ...
  public void exportMoveLineTypeSelect1007FILE1(MoveLineReport moveLineReport, boolean replay)
    ...
    String fileName = "entete" + todayTime.toString(DATE_FORMAT_YYYYMMDDHHMMSS) + "avoirs.dat";
    String filePath =
        accountConfigService.getExportPath(accountConfigService.getAccountConfig(company));
    new File(filePath).mkdirs();
  ...
  public void exportMoveLineTypeSelect1008(MoveLineReport moveLineReport, boolean replay)
    ...
    String fileName = "detail" + todayTime.toString(DATE_FORMAT_YYYYMMDDHHMMSS) + "tresorerie.dat";
  ...
  public void exportMoveLineTypeSelect1008FILE1(MoveLineReport moveLineReport, boolean replay)
    ...
    String fileName = "entete" + todayTime.toString(DATE_FORMAT_YYYYMMDDHHMMSS) + "tresorerie.dat";
    String filePath =
        accountConfigService.getExportPath(accountConfigService.getAccountConfig(company));
    new File(filePath).mkdirs();
  ...
  public void exportMoveLineTypeSelect1009(MoveLineReport moveLineReport, boolean replay)
    ...
    String fileName = "detail" + todayTime.toString(DATE_FORMAT_YYYYMMDDHHMMSS) + "achats.dat";
  ...
  public void exportMoveLineTypeSelect1009FILE1(MoveLineReport moveLineReport, boolean replay)
    ...
    String fileName = "entete" + todayTime.toString(DATE_FORMAT_YYYYMMDDHHMMSS) + "achats.dat";
    String filePath =
        accountConfigService.getExportPath(accountConfigService.getAccountConfig(company));
    new File(filePath).mkdirs();
  ...
  public void exportMoveLineTypeSelect1000(
      MoveLineReport moveLineReport, boolean administration, boolean replay)
      throws AxelorException, IOException {
    ...
    if (moveLineReport.getYear() != null) {
      moveLineQueryStr +=
          String.format(" AND self.move.period.year = %s", moveLineReport.getYear().getId());
    }

    if (moveLineReport.getPeriod() != null) {
      moveLineQueryStr +=
          String.format(" AND self.move.period = %s", moveLineReport.getPeriod().getId());
    } else {
      if (moveLineReport.getDateFrom() != null) {
        moveLineQueryStr +=
            String.format(" AND self.date >= '%s'", moveLineReport.getDateFrom().toString());
    ...
    if (!administration) {
      ...
      if (replay) {
        moveLineQueryStr +=
            String.format(
                " AND self.move.accountingOk = true AND self.move.moveLineReport.id = %s",
    ...
    if (!moveLineList.isEmpty()) {
      ...
      for (MoveLine moveLine : moveLineList) {
        ...
        items[3] = moveLine.getDate().toString(DATE_FORMAT_YYYYMMDD);
        ...
        items[9] =
            moveLine
                .getDate()
                .toString(DATE_FORMAT_YYYYMMDD); // Pour le moment on va utiliser la date des lignes
        // d'écriture.
        ...
        if (moveLine.getDebit().compareTo(BigDecimal.ZERO) > 0) {
          ...
          for (Reconcile reconcile : moveLine.getDebitReconcileList()) {
            ...
            reconcileDateList.add(reconcile.getReconciliationDate().toString(DATE_FORMAT_YYYYMMDD));
          }
          ...
          for (Reconcile reconcile : moveLine.getCreditReconcileList()) {
            if (reconcile.getStatusSelect() == ReconcileRepository.STATUS_CONFIRMED) {
              ...
              reconcileDateList.add(
                  reconcile.getReconciliationDate().toString(DATE_FORMAT_YYYYMMDD));
            }
          }
          items[13] = StringUtils.join(reconcileSeqList, "; ");
          items[14] = StringUtils.join(reconcileDateList, "; ");
        }
        items[15] = move.getValidationDate().toString(DATE_FORMAT_YYYYMMDD);
  ...
  public void exportMoveLineAllTypeSelectFILE2(MoveLineReport moveLineReport, String fileName)
    ...
    if (moveLineReport.getJournal() != null) {
      moveLineQueryStr +=
          String.format(" AND self.move.journal = %s", moveLineReport.getJournal().getId());
    } else {
      moveLineQueryStr +=
          String.format(
              " AND self.move.journal.type = %s",
              ...
              if (moveLines.size() > 0) {
                ...
                for (MoveLine moveLine3 : sortMoveLineList) {
                  ...
                  if (typeSelect == 9) {
                    ...
                    items[9] =
                        String.format("%s DU %s", journal.getCode(), date.toString("dd/MM/yyyy"));
                  } else {

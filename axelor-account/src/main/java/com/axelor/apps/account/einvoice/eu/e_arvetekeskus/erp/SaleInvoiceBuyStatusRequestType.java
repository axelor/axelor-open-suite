...
/**
 * Java class for SaleInvoiceBuyStatusRequestType complex type.
 *
...
@XmlType(
    name = "SaleInvoiceBuyStatusRequestType",
    propOrder = {"buyEvent"})
public class SaleInvoiceBuyStatusRequestType {
   ...
   * there is not a <CODE>set</CODE> method for the buyEvent property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link BuyInvoiceEventCodeType }
   */

...
public class OpportunitySaleOrderCashManagementServiceImpl
    extends OpportunitySaleOrderSupplychainServiceImpl {

  @Inject
  public OpportunitySaleOrderCashManagementServiceImpl(

...
public class InvoiceLineServiceGSTImpl extends InvoiceLineSupplychainService implements InvoiceLineServiceGST {
	...
	public Map<String, Object> fillProductInformation(Invoice invoice, InvoiceLine invoiceLine) throws AxelorException {
		...
		if (invoice.getCompany() == null || invoice.getCompany() == null || invoice.getCompany().getAddress() == null
	...
	@Override
	public Map<String, Object> fillProductInformationForInvoice(Invoice invoice, InvoiceLine invoiceLine) {

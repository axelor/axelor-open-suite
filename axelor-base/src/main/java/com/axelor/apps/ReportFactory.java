...
public class ReportFactory {
  ...
  public static ReportSettings createReport(
    ...
    if (template == null) {
      ...
      if (user != null) {
        for (UserDocumentTemplateAssignment assignment : user.getUserDocuTemplateAssignList()) {
      ...
      if (template == null && company != null) {
        for (CompanyDocumentTemplateAssignment assignment :
            company.getCompanyDocuTemplateAssignList()) {
          if (assignment.getType().equals(templateType)) {
            template = assignment.getTemplate();
          }
        }

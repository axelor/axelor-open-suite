...
public class BarcodeGeneratorServiceImpl implements BarcodeGeneratorService {
	...
	@Override
	public InputStream createBarCode(String serialno, BarcodeTypeConfig barcodeTypeConfig, boolean isPadding)
	...
	public InputStream generateBarcode(String serialno, BarcodeTypeConfig barcodeTypeConfig,
	...
	public String checkTypeForFixedLength(String serialno, BarcodeFormat barcodeFormat, int barcodeLength)
			throws AxelorException {

...
public class IndicatorServiceImpl implements IndicatorService {
  ...
  public void generate(IndicatorConfig config) throws AxelorException {
    LocalDate iterationDate = appBaseService.getTodayDate(null);

    IndicatorResult parent = resultService.initParent(config, iterationDate);
    ...
    lineService.createLines(config, parent, records, evaluator, iterationDate);

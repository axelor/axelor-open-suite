...
public class ExcelReportServiceImpl implements ExcelReportService {
  ...
  public File createReport(List<Long> objectIds, PrintTemplate printTemplate)
    ...
    dataMapService = new ExcelReportDataMapService(printTemplate, objectIds);
    ...
    Workbook newWb =
        dataMapService.createWorkbook(
            ...
            Beans.get(ExcelReportHelperService.class)
                .getMapper(printTemplate.getMetaModel().getFullName()),
  ...
  protected File getPdfFile(File excelFile)
    ...
    Excel2HtmlConvertor toHtml =
        Excel2HtmlConvertor.create(
            excelFile.getPath(),
            Beans.get(ExcelReportHeaderService.class).generateHeaderHtml(dataMapService.getPrint()),
            Beans.get(ExcelReportFooterService.class).generateFooterHtml(dataMapService.getPrint()),
            dataMapService.getPrintTemplate(),
            dataMapService.getPrint());
    ...
    return Beans.get(Html2PdfConvertorService.class)
        .toPdf(html, attachmentPath, dataMapService.getPrintTemplate());
  }
  ...
  protected void attachMetaFile(File file, Model model) throws IOException {
    ...
    Beans.get(MetaFiles.class).attach(FileUtils.openInputStream(file), fileName, model);
  }

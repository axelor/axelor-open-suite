...
public class CurrencyConversionService {
  ...
  public BigDecimal convert(Currency currencyFrom, Currency currencyTo) {
    ...
    if (currencyFrom != null && currencyTo != null) {
      try {
        ...
        if (response.getStatusCode() != 200) return rate;
        Float rt =
  ...
  public String getVariations(BigDecimal currentRate, BigDecimal previousRate) {
    ...
    if (currentRate != null
      ...
      variation =
          variation.setScale(IAdministration.DEFAULT_NB_DECIMAL_DIGITS, RoundingMode.HALF_EVEN);
  ...
  public void createCurrencyConversionLine(
      ...
      String variations) {
    LOG.debug(
        "Create new currency conversion line CurrencyFrom: {}, CurrencyTo: {},FromDate: {},ConversionRate: {}, General: {}, Variations: {}",
  ...
  public BigDecimal getRate(Currency currencyFrom, Currency currencyTo, LocalDate rateDate) {
    ...
    LOG.debug(
        "Get Last rate for CurrencyFrom: {} CurrencyTo: {} RateDate: {}",
        new Object[] {currencyFrom, currencyTo, rateDate});
      ...
      CurrencyConversionLine ccl =
          cclRepo
              ...
              .filter(
                  ...
                  rateDate)
              .fetchOne();
      if (ccl != null) rate = ccl.getExchangeRate();
    }

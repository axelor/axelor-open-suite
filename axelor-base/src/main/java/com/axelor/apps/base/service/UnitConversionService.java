...
public class UnitConversionService {
  ...
  @Inject private UnitConversionRepository unitConversionRepo;

  /**
   * Obtenir le coefficient entre deux unités dans une liste de conversion. Si l'unité de départ et
   * l'unité d'arrivée ne se trouve pas dans la liste alors on inverse l'unité de départ avec
  ...
  public BigDecimal getCoefficient(
    ...
    throw new AxelorException(
        String.format(
            I18n.get(IExceptionMessage.UNIT_CONVERSION_1), startUnit.getName(), endUnit.getName()),
  ...
  public BigDecimal convert(
      List<UnitConversion> unitConversionList, Unit startUnit, Unit endUnit, BigDecimal value)
      throws AxelorException {

    if (startUnit == null || endUnit == null)
      throw new AxelorException(
          I18n.get(IExceptionMessage.UNIT_CONVERSION_2), IException.CONFIGURATION_ERROR);
    ...
    if (startUnit.equals(endUnit)) return value;
      ...
      return value
          ...
          .setScale(generalService.getNbDecimalDigitForUnitPrice(), RoundingMode.HALF_EVEN);
    }
  }
      ...
      if (unitConversion.getStartUnit().equals(endUnit)
        ...
        if (unitConversion.getTypeSelect() == UnitConversionRepository.TYPE_COEFF
          ...
          if (result.compareTo(BigDecimal.ZERO) != 0) {
            return BigDecimal.ONE.divide(
                result, generalService.getNbDecimalDigitForUnitPrice(), RoundingMode.HALF_EVEN);
          }
        }
      }
    }

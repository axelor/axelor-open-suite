...
import com.axelor.apps.base.service.advanced.imports.AdvancedImportFileFieldServiceImpl;
import com.axelor.apps.base.service.advanced.imports.AdvancedImportFileTabService;
import com.axelor.apps.base.service.advanced.imports.AdvancedImportFileTabServiceImpl;
...
public class BaseModule extends AxelorModule {
  ...
  protected void configure() {
    ...
    bind(AdvancedImportFileTabService.class).to(AdvancedImportFileTabServiceImpl.class);
    bind(AdvancedImportFileFieldService.class).to(AdvancedImportFileFieldServiceImpl.class);

...
import com.axelor.apps.base.service.excelreport.ExcelReportServiceImpl;
import com.axelor.apps.base.service.excelreport.components.ExcelReportCellService;
import com.axelor.apps.base.service.excelreport.components.ExcelReportCellServiceImpl;
import com.axelor.apps.base.service.excelreport.components.ExcelReportFooterService;
import com.axelor.apps.base.service.excelreport.components.ExcelReportFooterServiceImpl;
import com.axelor.apps.base.service.excelreport.components.ExcelReportHeaderService;
import com.axelor.apps.base.service.excelreport.components.ExcelReportHeaderServiceImpl;
import com.axelor.apps.base.service.excelreport.components.ExcelReportPictureService;
import com.axelor.apps.base.service.excelreport.components.ExcelReportPictureServiceImpl;
import com.axelor.apps.base.service.excelreport.config.ExcelReportHelperService;
import com.axelor.apps.base.service.excelreport.config.ExcelReportHelperServiceImpl;
...
import com.axelor.apps.base.service.excelreport.utility.CollectionColumnHidingServiceImpl;
import com.axelor.apps.base.service.excelreport.utility.ExcelReportCellMergingService;
import com.axelor.apps.base.service.excelreport.utility.ExcelReportCellMergingServiceImpl;
import com.axelor.apps.base.service.excelreport.utility.ExcelReportGroovyService;
import com.axelor.apps.base.service.excelreport.utility.ExcelReportGroovyServiceImpl;
import com.axelor.apps.base.service.excelreport.utility.ExcelReportShiftingService;
import com.axelor.apps.base.service.excelreport.utility.ExcelReportShiftingServiceImpl;
import com.axelor.apps.base.service.excelreport.utility.ExcelReportTranslationService;
import com.axelor.apps.base.service.excelreport.utility.ExcelReportTranslationServiceImpl;
import com.axelor.apps.base.service.excelreport.utility.ExcelReportWriteService;
import com.axelor.apps.base.service.excelreport.utility.ExcelReportWriteServiceImpl;
import com.axelor.apps.base.service.excelreport.utility.ReportQueryBuilderService;
import com.axelor.apps.base.service.excelreport.utility.ReportQueryBuilderServiceImpl;
...
public class BaseModule extends AxelorModule {
  ...
  protected void configure() {
    ...
    bind(ExcelReportService.class).to(ExcelReportServiceImpl.class);
    bind(ExcelReportCellMergingService.class).to(ExcelReportCellMergingServiceImpl.class);
    bind(Html2PdfConvertorService.class).to(Html2PdfConvertorServiceImpl.class);
    bind(ExcelReportGroovyService.class).to(ExcelReportGroovyServiceImpl.class);
    bind(ExcelReportTranslationService.class).to(ExcelReportTranslationServiceImpl.class);
    bind(ExcelReportPictureService.class).to(ExcelReportPictureServiceImpl.class);
    bind(ExcelReportCellService.class).to(ExcelReportCellServiceImpl.class);
    bind(ExcelReportHeaderService.class).to(ExcelReportHeaderServiceImpl.class);
    bind(ExcelReportFooterService.class).to(ExcelReportFooterServiceImpl.class);
    bind(ExcelReportWriteService.class).to(ExcelReportWriteServiceImpl.class);
    bind(ExcelReportShiftingService.class).to(ExcelReportShiftingServiceImpl.class);
    bind(ReportQueryBuilderService.class).to(ReportQueryBuilderServiceImpl.class);
    bind(ExcelReportHelperService.class).to(ExcelReportHelperServiceImpl.class);
    bind(CollectionColumnHidingService.class).to(CollectionColumnHidingServiceImpl.class);
  }
}

...
public class ProductServiceImpl implements ProductService {
  ...
  @Inject private ProductVariantService productVariantService;

  @Inject private ProductVariantRepository productVariantRepo;
            ...
            product
                ...
                .add(
                    this.getProductExtraPrice(
                        product.getProductVariant(), IProductVariant.APPLICATION_COST_PRICE)));
      }
    }
    ...
    if (product.getCostPrice() != null && managePriceCoef != null) {
      ...
      product.setSalePrice(
          (product.getCostPrice().multiply(managePriceCoef))
              .setScale(generalService.getNbDecimalDigitForUnitPrice(), BigDecimal.ROUND_HALF_UP));
      ...
      if (product.getProductVariant() != null) {
        ...
        product.setSalePrice(
            product
                ...
                .add(
                    this.getProductExtraPrice(
                        product.getProductVariant(), IProductVariant.APPLICATION_SALE_PRICE)));
      }
    }

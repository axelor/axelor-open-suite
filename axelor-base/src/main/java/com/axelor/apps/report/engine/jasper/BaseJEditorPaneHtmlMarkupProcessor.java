...
/** Specific implementation of HTML formatting to avoid inconsistencies with lists w.r.t BIRT. */
public class BaseJEditorPaneHtmlMarkupProcessor extends JEditorPaneHtmlMarkupProcessor {

  private final Logger log = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());

  private static BaseJEditorPaneHtmlMarkupProcessor instance;

  public static BaseJEditorPaneHtmlMarkupProcessor getInstance() {
    if (instance == null) {
      instance = new BaseJEditorPaneHtmlMarkupProcessor();
    }
    return instance;
  }

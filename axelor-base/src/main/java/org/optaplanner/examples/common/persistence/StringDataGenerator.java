...
public class StringDataGenerator {
  ...
  public static StringDataGenerator buildFullNames() {
    return new StringDataGenerator()
        .addPart(true, 0, "Amy", "Beth", "Chad", "Dan", "Elsa", "Flo", "Gus", "Hugo", "Ivy", "Jay")
        .addPart(false, 1, "A.", "B.", "C.", "D.", "E.", "F.", "G.", "H.", "I.", "J.")
        .addPart(false, 1, "O.", "P.", "Q.", "R.", "S.", "T.", "U.", "V.", "W.", "X.")
        .addPart(
            false, 1, "Cole", "Fox", "Green", "Jones", "King", "Li", "Poe", "Rye", "Smith", "Watt");
  }
  ...
  public static StringDataGenerator buildCompanyNames() {
    return new StringDataGenerator()
        .addPart(
            ...
            "Computer")
        .addPart(
            true, 1, "Inc", "Corp", "Limited", "Express", "Telco", "Mobile", "Soft", "Mart", "Bank",
            "Labs")
  ...
  public static StringDataGenerator buildLocationNames() {
    return new StringDataGenerator()
        .addPart(
            true, 0, "Los", "San", "Las", "Santa", "New", "Fort", "Mount", "Saint", "Little", "El")
        .addPart(
            true,
            1,
            "Angeles",
            ...
            "Paso")
        .addPart(
            false, 2, "Town", "City", "Falls", "Ville", "Field", "Polis", "Shire", "Berg",
            "Borough", "Island")
  ...
  public static StringDataGenerator buildAssemblyLineNames() {
    return new StringDataGenerator()
        ...
        .addPart(
            ...
            "GPS")
        .addPart(
            false, 0, "line 1", "line 2", "line 3", "line 4", "line 5", "line 6", "line 7",
            "line 8", "line 9", "line 10", "line 11", "line 12", "line 13", "line 14", "line 15");
  }

  /**
   * Determines how to go through the unique combinations to maximize uniqueness, even on small
   * subsets. It does not scroll per digit (0000, 1111, 2222, 0001, 1112, 2220, 0002, 1110, 2221,
   * ...). Instead, it scrolls per half (0000, 1111, 2222, 0011, 1122, 2200, 0022, 1100, 2211, ...).
   */
  private static final int[][] HALF_SEQUENCE_MAP =
      new int[][] {{}, {0}, {0, 1}, {0, 2, 1}, {0, 2, 1, 3}};
  ...
  public StringDataGenerator addNumericPart(
      boolean required, int eliminationIndex, int from, int to) {
  ...
  public String generateNextValue() {
    ...
    for (int i = 0; i < listSize; i++) {
      int chosen =
          (previousChosen
                  + (index
                      % (int) Math.pow(partValuesLength, halfSequence[i] + 1)

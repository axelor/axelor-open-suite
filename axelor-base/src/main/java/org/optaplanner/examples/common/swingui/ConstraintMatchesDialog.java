...
public class ConstraintMatchesDialog extends JDialog {
  ...
  public ConstraintMatchesDialog(
      SolverAndPersistenceFrame solverAndPersistenceFrame, SolutionBusiness solutionBusiness) {
  ...
  public void resetContentPanel() {
    ...
    if (!solutionBusiness.isConstraintMatchEnabled()) {
      ...
      JLabel unsupportedLabel =
          new JLabel("Constraint matches are not supported with this ScoreDirector.");
  ...
  public String buildConstraintMatchSetText(ConstraintMatchTotal constraintMatchTotal) {
    Set<? extends ConstraintMatch> constraintMatchSet =
    ...
    for (ConstraintMatch constraintMatch : constraintMatchSet) {
      text.append(constraintMatch.getJustificationList())
          .append(" = ")

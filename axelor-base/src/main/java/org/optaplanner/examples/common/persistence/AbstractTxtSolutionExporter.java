...
public abstract class AbstractTxtSolutionExporter<Solution_>
  ...
  public void writeSolution(Solution_ solution, File outputFile) {
    try (BufferedWriter writer =
      ...
      throw new IllegalArgumentException(
          "Could not write the file (" + outputFile.getName() + ").", e);
    }
  }

  public abstract static class TxtOutputBuilder<Solution_> extends OutputBuilder {

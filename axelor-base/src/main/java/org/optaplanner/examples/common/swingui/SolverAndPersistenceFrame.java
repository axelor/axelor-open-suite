...
public class SolverAndPersistenceFrame<Solution_> extends JFrame {
  ...
  public static final ImageIcon OPTA_PLANNER_ICON =
      new ImageIcon(SolverAndPersistenceFrame.class.getResource("optaPlannerIcon.png"));
  ...
  public SolverAndPersistenceFrame(
      SolutionBusiness<Solution_> solutionBusiness, SolutionPanel<Solution_> solutionPanel) {
    ...
    indictmentHeatMapTrueIcon =
        new ImageIcon(getClass().getResource("indictmentHeatMapTrueIcon.png"));
    indictmentHeatMapFalseIcon =
        new ImageIcon(getClass().getResource("indictmentHeatMapFalseIcon.png"));
    refreshScreenDuringSolvingTrueIcon =
        new ImageIcon(getClass().getResource("refreshScreenDuringSolvingTrueIcon.png"));
    refreshScreenDuringSolvingFalseIcon =
        new ImageIcon(getClass().getResource("refreshScreenDuringSolvingFalseIcon.png"));
    registerListeners();
  ...
  private JComponent createQuickOpenUnsolvedPanel() {
    ...
    return createQuickOpenPanel(
        quickOpenUnsolvedJList, "Unsolved dataset shortcuts", unsolvedFileList);
  }
  ...
  private JComponent createQuickOpenPanel(
      JList<QuickOpenAction> listPanel, String title, List<File> fileList) {
  ...
  private void refreshQuickOpenPanel(JList<QuickOpenAction> listPanel, List<File> fileList) {
    DefaultListModel<QuickOpenAction> model =
        (DefaultListModel<QuickOpenAction>) listPanel.getModel();
    model.clear();
  ...
  private class TerminateSolvingEarlyAction extends AbstractAction {
    ...
    public TerminateSolvingEarlyAction() {
      super(
          ...
          new ImageIcon(
              SolverAndPersistenceFrame.class.getResource("terminateSolvingEarlyAction.png")));
    }
  ...
  private class OpenAction extends AbstractAction {
    ...
    public OpenAction() {
      ...
      final String inputFileExtension =
          solutionBusiness.getSolutionFileIO().getOutputFileExtension();
  ...
  private class SaveAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      fileChooser.setSelectedFile(
          new File(
              solutionBusiness.getSolvedDataDir(),
    ...
    public ExportAction() {
      ...
      fileChooser.setFileFilter(
          new FileFilter() {
            ...
            public boolean accept(File file) {
              return file.isDirectory()
                  || file.getName().endsWith("." + solutionBusiness.getExportFileSuffix());
            }
  ...
  private JPanel createMiddlePanel() {
    ...
    ImageIcon usageExplanationIcon =
        new ImageIcon(getClass().getResource(solutionPanel.getUsageExplanationPath()));
  ...
  private JPanel createScorePanel() {
    ...
    indictmentHeatMapToggleButton.addActionListener(
        e -> {
          boolean selected = indictmentHeatMapToggleButton.isSelected();
          indictmentHeatMapToggleButton.setIcon(
              selected ? indictmentHeatMapTrueIcon : indictmentHeatMapFalseIcon);
    ...
    refreshScreenDuringSolvingToggleButton =
        new JToggleButton(refreshScreenDuringSolvingTrueIcon, true);
    refreshScreenDuringSolvingToggleButton.setToolTipText("Refresh screen during solving");
    refreshScreenDuringSolvingToggleButton.addActionListener(
        e -> {
          refreshScreenDuringSolvingToggleButton.setIcon(
              refreshScreenDuringSolvingToggleButton.isSelected()
                  ? refreshScreenDuringSolvingTrueIcon
                  : refreshScreenDuringSolvingFalseIcon);
        });
  ...
  private class ShowConstraintMatchesDialogAction extends AbstractAction {
    ...
    public ShowConstraintMatchesDialogAction() {
      super(
          "Constraint matches",
          new ImageIcon(
              SolverAndPersistenceFrame.class.getResource(
                  "showConstraintMatchesDialogAction.png")));
    }
  ...
  private void setSolvingState(boolean solving) {
    ...
    indictmentHeatMapToggleButton.setEnabled(
        solutionPanel.isIndictmentHeatMapEnabled() && !solving);
  ...
  private Color determineScoreFieldForeground(Score<?> score) {
    if (!score.isSolutionInitialized()) {
      ...
      return feasibilityScore.isFeasible()
          ? TangoColorFactory.CHAMELEON_3
          : TangoColorFactory.ORANGE_3;
    }
  }
}

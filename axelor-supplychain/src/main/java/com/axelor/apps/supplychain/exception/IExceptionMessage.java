...
public interface IExceptionMessage {
  ...
  static final String STOCK_MOVE_MULTI_FISCAL_POSITION_PO = /*$$(*/
      "The fiscal position must be the same for all purchase orders" /*)*/;
  static final String STOCK_MOVE_MULTI_FISCAL_POSITION_SO = /*$$(*/
  ...
  static final String STOCK_MOVE_CANCEL_WRONG_STATUS_ERROR = /*$$(*/
      "Can't cancel a stock move that is partially or totally invoiced." /*)*/;
  static final String STOCK_MOVE_CANCEL_WRONG_INVOICE_STATUS_ALERT = /*$$(*/

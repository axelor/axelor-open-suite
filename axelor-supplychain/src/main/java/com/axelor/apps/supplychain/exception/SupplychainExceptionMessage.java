...
public final class SupplychainExceptionMessage {
  ...
  public static final String SALE_ORDER_ESTIMATED_DELIVERY_DATE_NOT_UPDATED = /*$$(*/
      "Warning : Estimated delivery date isn't updated due to pricing set on sale order." /*)*/;
}

...
// TODO interface
public class AccountingCutOffService {
  ...
  @Inject
  public AccountingCutOffService(
  ...
  public List<MoveLine> generateMoveLines(
      Move move,
  ...
  public MoveLine generateProductMoveLine(
      Move move,
  ...
  public void generateTaxMoveLine(
      Move move,
  ...
  public void getAndComputeAnalyticDistribution(Product product, Move move, MoveLine moveLine) {

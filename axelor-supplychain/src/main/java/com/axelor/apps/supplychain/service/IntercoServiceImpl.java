...
public class IntercoServiceImpl implements IntercoService {
  ...
  public Invoice generateIntercoInvoice(Invoice invoice) throws AxelorException {
    ...
    InvoiceGenerator invoiceGenerator = Beans.get(InvoiceGenerator.class);
    ...
    invoice.setInvoiceLineTaxList(
        (new TaxInvoiceLine(intercoInvoice, intercoInvoice.getInvoiceLineList())).creates());
    invoiceGenerator.computeInvoice(intercoInvoice);

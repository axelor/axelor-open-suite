...
public class ITranslation {
   ...
   * Packing list
   */
  public static final String PACKING_LIST_PACKING_NUMBER = /*$$(*/ "Packing number:" /*)*/;
  ...
  public static final String PACKING_LIST_PARCEL_LINE_FORMAT = /*$$(*/
      "Parcel No. <strong>{0}</strong> - Dimensions (cm): <strong>{1}</strong> - Gross weight ({2}): <strong>{3}</strong>" /*)*/;
  public static final String PACKING_LIST_PALLET_LINE_FORMAT = /*$$(*/
      "Pallet No. <strong>{0}</strong> - Dimensions (cm): <strong>{1}</strong> - Gross weight ({2}): <strong>{3}</strong>" /*)*/;

...
public interface ProductMergeService {
  ...
  /**
   * Checks that the given user is allowed to merge products, following the list of authorized users
   * of the Supplychain app configuration.
   *
   * @throws AxelorException if the user is not allowed to merge products
   */
  void checkAuthorization(User user) throws AxelorException;

  /**
   * Checks every condition blocking the merge of the absorbed product into the kept product.
   *

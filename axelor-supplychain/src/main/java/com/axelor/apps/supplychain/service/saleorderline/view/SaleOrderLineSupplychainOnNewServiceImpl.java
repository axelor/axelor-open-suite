...
public class SaleOrderLineSupplychainOnNewServiceImpl
    ...
    public Map<String, Map<String, Object>> getSupplychainOnNewAttrs(
        ...
        MapTools.addMap(attrs, saleOrderLineSupplychainViewService.hideAllocatedQtyBtn(saleOrder, saleOrderLine));
        analyticAttrsService.addAnalyticAxisAttrs(saleOrder.getCompany(), null, attrs);
        MapTools.addMap(attrs, saleOrderLineSupplychainViewService.setAnalyticDistributionPanelHidden(saleOrder, saleOrderLine));

...
public class ValidateSupplyChain {
  ...
  @Inject PurchaseOrderServiceSupplychainImpl purchaseOrderServiceSupplychainImpl;

  @Inject InvoiceService invoiceService;

  @Inject SaleOrderStockService saleOrderStockService;
  ...
  public Object validateSupplyChain(Object bean, Map values) {
    String objectQuery =
        "(SELECT 'inv' as type,id,datet as date from stock_inventory) "
    ...
    for (Object objects : query.getResultList()) {
      ...
      else validateSaleOrder(Long.parseLong(object[1].toString()));
    }
    return bean;
  }

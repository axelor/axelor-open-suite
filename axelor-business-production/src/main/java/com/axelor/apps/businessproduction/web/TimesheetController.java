...
public class TimesheetController {
   ...
   * Call {@link ManufacturingOperationTimesheetService#updateAllRealDuration(List)}.
   *
   * @param request
   * @param response
   */
  public void updateManufacturingOperations(ActionRequest request, ActionResponse response) {
    try {

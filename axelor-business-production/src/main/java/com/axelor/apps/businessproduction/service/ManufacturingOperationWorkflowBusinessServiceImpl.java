...
public class ManufacturingOperationWorkflowBusinessServiceImpl
    extends ManufacturingOperationWorkflowServiceImpl {

  protected TimesheetLineBusinessProductionService tslBusinessProductionService;

  @Inject
  public ManufacturingOperationWorkflowBusinessServiceImpl(
  ...
  public void stopManufacturingOperationDuration(ManufacturingOperationDuration duration)
    ...
    super.stopManufacturingOperationDuration(duration);
    if (appProductionService.isApp("production")
      ...
      tslBusinessProductionService
          ...
          .ifPresent(
              tsl -> {
                if (duration.getManufacturingOperation() != null) {
                  duration.getManufacturingOperation().addTimesheetLineListItem(tsl);
                }
              });
    }
  }

...
public interface ManufacturingOperationTimesheetService {
   ...
   */
  void updateManufacturingOperation(
   ...
   */
  void updateManufacturingOperations(Timesheet timesheet) throws AxelorException;

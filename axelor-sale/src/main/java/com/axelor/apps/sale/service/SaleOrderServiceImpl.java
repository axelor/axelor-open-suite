...
public class SaleOrderServiceImpl implements SaleOrderService {
  ...
  public String getSequence(Company company) throws AxelorException {
    ...
    if (seq == null) {
      throw new AxelorException(
          String.format(I18n.get(IExceptionMessage.SALES_ORDER_1), company.getName()),
  ...
  public String getLanguageForPrinting(SaleOrder saleOrder) {
    ...
    try {
      language =
          saleOrder.getClientPartner().getLanguageSelect() != null
              ? saleOrder.getClientPartner().getLanguageSelect()
              : saleOrder.getCompany().getPrintingSettings().getLanguageSelect() != null
                  ? saleOrder.getCompany().getPrintingSettings().getLanguageSelect()
                  : "en";

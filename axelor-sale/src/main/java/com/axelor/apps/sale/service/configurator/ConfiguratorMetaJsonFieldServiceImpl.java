...
public class ConfiguratorMetaJsonFieldServiceImpl implements ConfiguratorMetaJsonFieldService {
   ...
   * @return Map if generateAttrMap is found else null
   */
   ...
   *
   * @param model
   * @return Map if modelToJson is found else null
   */
   ...
   *
   * @param map
   * @return Map if objectMapToJson is found else null
   */
   ...
   * @param object
   * @param metaJsonField
   * @return Map.Entry if adaptType is found else null
   */

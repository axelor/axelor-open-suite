...
public class ConfiguratorSaleOrderLineServiceImpl  implements ConfiguratorSaleOrderLineService {
    ...
    @Inject
    public ConfiguratorSaleOrderLineServiceImpl(ConfiguratorCheckService configuratorCheckService, SaleOrderLineRepository saleOrderLineRepository, SaleOrderLineGeneratorService saleOrderLineGeneratorService, SaleOrderComputeService saleOrderComputeService, SaleOrderRepository saleOrderRepository) {
    ...
    public void regenerateSaleOrderLines(Configurator configurator, Product product) throws AxelorException {
        ...
        var saleOrderLines = saleOrderLineRepository.all().filter("self.product = :product AND self.configurator = :configurator AND self.saleOrder.statusSelect = :draftStatus")

...
public abstract class AbstractPersistable implements Serializable, Comparable<AbstractPersistable> {
  ...
  // This part is currently commented out because it's probably a bad thing to mix identification
  // with equality
  ...
  /**
   * Used by the GUI to sort the {@link ConstraintMatch} list by {@link

...
import com.axelor.apps.production.service.ProductMergeServiceProductionImpl;
...
public class ProductionModule extends AxelorModule {
  ...
  protected void configure() {
    ...
    bind(ProductMergeServiceImpl.class).to(ProductMergeServiceProductionImpl.class);

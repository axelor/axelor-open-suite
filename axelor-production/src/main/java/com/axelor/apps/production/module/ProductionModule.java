...
import com.axelor.apps.production.service.StockMoveLineServiceProductionImpl;
...
public class ProductionModule extends AxelorModule {
  ...
  protected void configure() {
    ...
    bind(StockMoveLineServiceSupplychainImpl.class).to(StockMoveLineServiceProductionImpl.class);

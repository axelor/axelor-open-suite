...
public interface ITranslation {
  ...
  public static final String MANUFACTURING_OPERATION_DURATION_PAUSED_200 = /*$$(*/
      "Your time on this operation is paused. The status of the operation has not been updated as someone is still working on it." /*)*/;

  public static final String MANUFACTURING_OPERATION_WORKFLOW_NOT_SUPPORTED = /*$$(*/
      "This workflow is not supported for operation order status." /*)*/;

  public static final String MANUFACTURING_OPERATION_DURATION_PAUSED_403 = /*$$(*/

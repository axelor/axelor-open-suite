...
public class CostSheetLineServiceImpl implements CostSheetLineService {
  ...
  public CostSheetLine createCostSheetLine(
    ...
    costSheetLine.setConsumptionQty(consumptionQty.setScale(appBaseService.getNbDecimalDigitForQty(), RoundingMode.HALF_EVEN));
  ...
  public CostSheetLine createConsumedProductCostSheetLine(
    ...
    consumptionQty = consumptionQty.setScale(appBaseService.getNbDecimalDigitForQty(), RoundingMode.HALF_EVEN);

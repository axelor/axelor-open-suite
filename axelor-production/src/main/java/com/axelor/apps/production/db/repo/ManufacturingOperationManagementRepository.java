...
public class ManufacturingOperationManagementRepository extends ManufacturingOperationRepository {

  @Inject ManufacturingOperationService manufacturingOperationService;

  @Override
  public ManufacturingOperation save(ManufacturingOperation entity) {

    if (entity.getBarCode() == null) {
      entity = super.save(entity);
      manufacturingOperationService.createBarcode(entity);
    }

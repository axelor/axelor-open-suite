...
public interface DepRateCalculationService {
   ...
   * calculation.
   *
   * @param unitCostCalculation the calculation configuration
   * @throws AxelorException if an error occurs
   */
   ...
   *
   * @param unitCostCalculation the calculation with computed rates

...
public class OperationOrderController {
	...
	public void chargeByMachineHours(ActionRequest request, ActionResponse response) {
	    try {
			...
			List<Map<String, Object>> dataList = Beans.get(OperationOrderService.class).chargeByMachineHours(fromDateTime, toDateTime);
	...
	public void chargeByMachineDays(ActionRequest request, ActionResponse response) {
	    ...
	    try {
			...
			List<Map<String, Object>> dataList = Beans.get(OperationOrderService.class).chargeByMachineDays(fromDateTime, toDateTime);
			response.setData(dataList);
		} catch (Exception e) {
			TraceBackService.trace(response, e);
		}

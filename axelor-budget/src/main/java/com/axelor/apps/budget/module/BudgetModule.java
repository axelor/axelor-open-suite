...
import com.axelor.apps.budget.service.compute.BudgetComputeServiceImpl;
import com.axelor.apps.budget.service.compute.BudgetDistributionComputeService;
import com.axelor.apps.budget.service.compute.BudgetDistributionComputeServiceImpl;
...
import com.axelor.apps.contract.db.repo.SaleOrderContractRepository;
...
public class BudgetModule extends AxelorModule {
  ...
  protected void configure() {
    ...
    bind(InvoiceContractRepository.class).to(BudgetInvoiceRepository.class);
    ...
    bind(SaleOrderInvoiceContractServiceImpl.class).to(SaleOrderBudgetServiceImpl.class);
    bind(StockMoveInvoiceServiceImpl.class).to(StockMoveInvoiceBudgetServiceImpl.class);
    ...
    bind(SaleOrderContractRepository.class).to(SaleOrderBudgetRepository.class);
    ...
    bind(BudgetDistributionComputeService.class).to(BudgetDistributionComputeServiceImpl.class);
    ...
    bind(BudgetComputeService.class).to(BudgetComputeServiceImpl.class);
  }
}

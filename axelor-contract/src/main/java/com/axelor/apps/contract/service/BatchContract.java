...
public class BatchContract extends BatchStrategy {
    ...
    protected void process() {
        try {
            ...
            Preconditions.checkNotNull(state, String.format(I18n.get("Action %s has no Batch implementation."),
    ...
    protected void stop() {
        super.stop();
        addComment(String.format("%d contract(s) treated and %d anomaly(ies) reported !",
                batch.getDone(),
                batch.getAnomaly()));
    }
}

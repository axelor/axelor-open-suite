...
public class ContractModule extends AxelorModule {
  ...
  protected void configure() {
    ...
    bind(InvoiceSupplychainRepository.class).to(InvoiceContractRepository.class);
    bind(SaleOrderSupplychainRepository.class).to(SaleOrderContractRepository.class);

...
public class MessageServiceImpl implements MessageService {
  ...
  public MessageServiceImpl(
      MetaAttachmentRepository metaAttachmentRepository, MailAccountService mailAccountService) {
  ...
  protected Message createMessage(
      ...
      int relatedTo1SelectId,
      String relatedTo2Select,
      int relatedTo2SelectId,
  ...
  public Message sendByEmail(Message message)
    ...
    com.axelor.mail.MailAccount account =
        new SmtpAccount(
            ...
            mailAccountService.getSmtpSecurity(mailAccount));
